...
#[allow(non_camel_case_types)]
pub type PFN_ChoosePixelFormat =
    unsafe extern "system" fn(_hDc: HDC, _pPfd: *const PIXELFORMATDESCRIPTOR);
#[allow(non_camel_case_types)]
...
pub type PFN_wglEnumerateVideoDevicesNV =
    unsafe extern "system" fn(_hDc: HDC, _phDeviceList: *mut HVIDEOOUTPUTDEVICENV);
#[allow(non_camel_case_types)]
