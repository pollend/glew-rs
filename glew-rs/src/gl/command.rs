...
pub type PFN_glEvalCoord1dv = unsafe extern "system" fn(_u: CoordD);
pub type PFN_glGlobalAlphaFactorubSUN = unsafe extern "system" fn(_factor: GLubyte);
pub type PFN_glIndexsv = unsafe extern "system" fn(_c: ColorIndexValueS);
...
pub type PFN_glIsPointInStrokePathNV =
    unsafe extern "system" fn(_path: Path, _x: GLfloat, _y: GLfloat);
...
pub type PFN_glMultiTexCoord2fv = unsafe extern "system" fn(_target: TextureUnit, _v: CoordF);
...
pub type PFN_glColor3s = unsafe extern "system" fn(_red: ColorS, _green: ColorS, _blue: ColorS);
...
pub type PFN_glGetTexParameterPointervAPPLE =
    unsafe extern "system" fn(_target: GLenum, _pname: GLenum, _params: GLvoid);
...
pub type PFN_glCopyTexSubImage1DEXT = unsafe extern "system" fn(
    _target: TextureTarget,
    _level: CheckedInt32,
    _xoffset: CheckedInt32,
    _x: WinCoord,
    _y: WinCoord,
    _width: GLsizei,
);
pub type PFN_glQueryCounter = unsafe extern "system" fn(_id: GLuint, _target: QueryCounterTarget);
pub type PFN_glMultiTexCoord3hvNV = unsafe extern "system" fn(_target: TextureUnit, _v: Half16NV);
pub type PFN_glCombinerOutputNV = unsafe extern "system" fn(
    ...
    _abDotProduct: Boolean,
    _cdDotProduct: Boolean,
    _muxSum: Boolean,
);
...
pub type PFN_glUnmapBuffer = unsafe extern "system" fn(_target: BufferTargetARB);
...
pub type PFN_glListParameterfvSGIX =
    unsafe extern "system" fn(_list: List, _pname: ListParameterName, _params: CheckedFloat32);
...
pub type PFN_glTextureImage2DEXT = unsafe extern "system" fn(
    ...
    _width: GLsizei,
    _height: GLsizei,
    _border: CheckedInt32,
    _format: PixelFormat,
    _type: PixelType,
    _pixels: GLvoid,
);
pub type PFN_glCombinerParameterivNV =
    unsafe extern "system" fn(_pname: CombinerParameterNV, _params: CheckedInt32);
pub type PFN_glPrioritizeTexturesEXT =
    unsafe extern "system" fn(_n: GLsizei, _textures: Texture, _priorities: ClampedFloat32);
pub type PFN_glIsEnabledIndexedEXT = unsafe extern "system" fn(_target: EnableCap, _index: GLuint);
pub type PFN_glSecondaryColor3svEXT = unsafe extern "system" fn(_v: ColorS);
pub type PFN_glMultiTexCoord1dvARB = unsafe extern "system" fn(_target: TextureUnit, _v: CoordD);
...
pub type PFN_glTexCoord4f =
    unsafe extern "system" fn(_s: CoordF, _t: CoordF, _r: CoordF, _q: CoordF);
...
pub type PFN_glVertex3fv = unsafe extern "system" fn(_v: CoordF);
...
pub type PFN_glDeleteTexturesEXT = unsafe extern "system" fn(_n: GLsizei, _textures: Texture);
...
pub type PFN_glMultiTexCoord1s = unsafe extern "system" fn(_target: TextureUnit, _s: CoordS);
pub type PFN_glWeightdvARB = unsafe extern "system" fn(_size: GLint, _weights: GLdouble);
pub type PFN_glGetFenceivNV =
    unsafe extern "system" fn(_fence: FenceNV, _pname: FenceParameterNameNV, _params: GLint);
...
pub type PFN_glPixelTexGenParameterfvSGIS =
    unsafe extern "system" fn(_pname: PixelTexGenParameterNameSGIS, _params: CheckedFloat32);
pub type PFN_glProgramUniform1f =
    unsafe extern "system" fn(_program: GLuint, _location: GLint, _v0: GLfloat);
pub type PFN_glGetNamedBufferSubData =
    unsafe extern "system" fn(_buffer: GLuint, _offset: GLintptr, _size: BufferSize, _data: GLvoid);
...
pub type PFN_glWindowPos3dv = unsafe extern "system" fn(_v: CoordD);
...
pub type PFN_glSecondaryColor3dvEXT = unsafe extern "system" fn(_v: ColorD);
...
pub type PFN_glGetPathDashArrayNV = unsafe extern "system" fn(_path: Path, _dashArray: GLfloat);
...
pub type PFN_glGetIntegerIndexedvEXT =
    unsafe extern "system" fn(_target: GetPName, _index: GLuint, _data: GLint);
pub type PFN_glSecondaryColor3fvEXT = unsafe extern "system" fn(_v: ColorF);
pub type PFN_glShadingRateSampleOrderNV = unsafe extern "system" fn(_order: GLenum);
pub type PFN_glStencilStrokePathNV =
    unsafe extern "system" fn(_path: Path, _reference: StencilValue, _mask: MaskedStencilValue);
...
pub type PFN_glBindVideoCaptureStreamBufferNV = unsafe extern "system" fn(
    ...
    _offset: BufferOffsetARB,
);
pub type PFN_glBinormal3dvEXT = unsafe extern "system" fn(_v: CoordD);
pub type PFN_glDrawElementsIndirect =
    unsafe extern "system" fn(_mode: PrimitiveType, _type: DrawElementsType, _indirect: GLvoid);
...
pub type PFN_glMultiTexCoord4dARB =
    unsafe extern "system" fn(_target: TextureUnit, _s: CoordD, _t: CoordD, _r: CoordD, _q: CoordD);
...
pub type PFN_glMultiTexCoord2ivARB = unsafe extern "system" fn(_target: TextureUnit, _v: CoordI);
pub type PFN_glNormalFormatNV = unsafe extern "system" fn(_type: GLenum, _stride: GLsizei);
pub type PFN_glQueryObjectParameteruiAMD = unsafe extern "system" fn(
    _target: QueryTarget,
    _id: GLuint,
    _pname: GLenum,
    _param: OcclusionQueryEventMaskAMD,
);
...
pub type PFN_glVertex3dv = unsafe extern "system" fn(_v: CoordD);
...
pub type PFN_glSampleMaskIndexedNV = unsafe extern "system" fn(_index: GLuint, _mask: SampleMaskNV);
pub type PFN_glColor4f =
    unsafe extern "system" fn(_red: ColorF, _green: ColorF, _blue: ColorF, _alpha: ColorF);
...
pub type PFN_glAlphaFuncxOES = unsafe extern "system" fn(_func: AlphaFunction, _ref: ClampedFixed);
pub type PFN_glPathGlyphsNV = unsafe extern "system" fn(
    ...
    _pathParameterTemplate: Path,
    _emScale: GLfloat,
);
pub type PFN_glMultiTexCoord2fARB =
    unsafe extern "system" fn(_target: TextureUnit, _s: CoordF, _t: CoordF);
pub type PFN_glVertex2hvNV = unsafe extern "system" fn(_v: Half16NV);
...
pub type PFN_glFogCoordPointer =
    unsafe extern "system" fn(_type: FogPointerTypeEXT, _stride: GLsizei, _pointer: GLvoid);
pub type PFN_glGetVertexAttribIuivEXT =
    unsafe extern "system" fn(_index: GLuint, _pname: VertexAttribEnum, _params: GLuint);
pub type PFN_glFogCoordhvNV = unsafe extern "system" fn(_fog: Half16NV);
...
pub type PFN_glGetObjectPtrLabel =
    unsafe extern "system" fn(_ptr: GLvoid, _bufSize: GLsizei, _length: GLsizei, _label: GLchar);
...
pub type PFN_glMultiTexCoord1dv = unsafe extern "system" fn(_target: TextureUnit, _v: CoordD);
...
pub type PFN_glVertexStream4ivATI =
    unsafe extern "system" fn(_stream: VertexStreamATI, _coords: GLint);
...
pub type PFN_glEdgeFlag = unsafe extern "system" fn(_flag: Boolean);
...
pub type PFN_glWindowPos3fv = unsafe extern "system" fn(_v: CoordF);
pub type PFN_glWindowPos2i = unsafe extern "system" fn(_x: CoordI, _y: CoordI);
...
pub type PFN_glColor4hNV =
    unsafe extern "system" fn(_red: Half16NV, _green: Half16NV, _blue: Half16NV, _alpha: Half16NV);
...
pub type PFN_glTexCoord1hNV = unsafe extern "system" fn(_s: Half16NV);
pub type PFN_glEvalCoord2fv = unsafe extern "system" fn(_u: CoordF);
pub type PFN_glCullFace = unsafe extern "system" fn(_mode: CullFaceMode);
pub type PFN_glFogCoorddvEXT = unsafe extern "system" fn(_coord: CoordD);
...
pub type PFN_glShadingRateImageBarrierNV = unsafe extern "system" fn(_synchronize: Boolean);
pub type PFN_glUniform4iARB =
    unsafe extern "system" fn(_location: GLint, _v0: GLint, _v1: GLint, _v2: GLint, _v3: GLint);
pub type PFN_glColor3uiv = unsafe extern "system" fn(_v: ColorUI);
...
pub type PFN_glWindowPos2iMESA = unsafe extern "system" fn(_x: CoordI, _y: CoordI);
pub type PFN_glDepthRangeIndexedfNV =
    unsafe extern "system" fn(_index: GLuint, _n: GLfloat, _f: GLfloat);
pub type PFN_glMultiTexCoord2svARB = unsafe extern "system" fn(_target: TextureUnit, _v: CoordS);
...
pub type PFN_glGetPerfMonitorCounterInfoAMD =
    unsafe extern "system" fn(_group: GLuint, _counter: GLuint, _pname: GLenum, _data: GLvoid);
pub type PFN_glProgramUniform4uiv =
    unsafe extern "system" fn(_program: GLuint, _location: GLint, _count: GLsizei, _value: GLuint);
pub type PFN_glWindowPos3dARB = unsafe extern "system" fn(_x: CoordD, _y: CoordD, _z: CoordD);
...
pub type PFN_glGetSamplerParameterIuiv =
    unsafe extern "system" fn(_sampler: GLuint, _pname: SamplerParameterI, _params: GLuint);
pub type PFN_glLockArraysEXT = unsafe extern "system" fn(_first: GLint, _count: GLsizei);
pub type PFN_glMultiTexCoord2iv = unsafe extern "system" fn(_target: TextureUnit, _v: CoordI);
pub type PFN_glMultiTexCoord3iv = unsafe extern "system" fn(_target: TextureUnit, _v: CoordI);
pub type PFN_glVertex4iv = unsafe extern "system" fn(_v: CoordI);
...
pub type PFN_glColor4fv = unsafe extern "system" fn(_v: ColorF);
...
pub type PFN_glGetMaterialiv =
    unsafe extern "system" fn(_face: MaterialFace, _pname: MaterialParameter, _params: GLint);
pub type PFN_glGetVertexAttribdvARB =
    unsafe extern "system" fn(_index: GLuint, _pname: VertexAttribPropertyARB, _params: GLdouble);
pub type PFN_glVertexAttrib1d = unsafe extern "system" fn(_index: GLuint, _x: GLdouble);
pub type PFN_glBindParameterEXT = unsafe extern "system" fn(_value: VertexShaderParameterEXT);
pub type PFN_glGetFloati_v =
    unsafe extern "system" fn(_target: GetPName, _index: GLuint, _data: GLfloat);
...
pub type PFN_glGetFloatIndexedvEXT =
    unsafe extern "system" fn(_target: GetPName, _index: GLuint, _data: GLfloat);
pub type PFN_glUseProgramObjectARB = unsafe extern "system" fn(_programObj: handleARB);
...
pub type PFN_glGetMultisamplefv =
    unsafe extern "system" fn(_pname: GetMultisamplePNameNV, _index: GLuint, _val: GLfloat);
...
pub type PFN_glSampleCoverageARB = unsafe extern "system" fn(_value: GLfloat, _invert: Boolean);
pub type PFN_glSecondaryColor3usEXT =
    unsafe extern "system" fn(_red: ColorUS, _green: ColorUS, _blue: ColorUS);
...
pub type PFN_glPointParameterfvSGIS =
    unsafe extern "system" fn(_pname: PointParameterNameARB, _params: CheckedFloat32);
...
pub type PFN_glIndexub = unsafe extern "system" fn(_c: ColorIndexValueUB);
...
pub type PFN_glGetTextureParameterIuiv =
    unsafe extern "system" fn(_texture: GLuint, _pname: GetTextureParameter, _params: GLuint);
...
pub type PFN_glMultiTexCoord3dARB =
    unsafe extern "system" fn(_target: TextureUnit, _s: CoordD, _t: CoordD, _r: CoordD);
pub type PFN_glDebugMessageCallbackARB =
    unsafe extern "system" fn(_callback: GLDEBUGPROCARB, _userParam: GLvoid);
...
pub type PFN_glBindTextureEXT =
    unsafe extern "system" fn(_target: TextureTarget, _texture: Texture);
...
pub type PFN_glColor4dv = unsafe extern "system" fn(_v: ColorD);
...
pub type PFN_glSecondaryColor3ui =
    unsafe extern "system" fn(_red: ColorUI, _green: ColorUI, _blue: ColorUI);
...
pub type PFN_glTexCoordP4uiv =
    unsafe extern "system" fn(_type: TexCoordPointerType, _coords: GLuint);
pub type PFN_glTestObjectAPPLE = unsafe extern "system" fn(_object: ObjectTypeAPPLE, _name: GLuint);
...
pub type PFN_glNormal3dv = unsafe extern "system" fn(_v: CoordD);
pub type PFN_glWindowPos4svMESA = unsafe extern "system" fn(_v: CoordS);
...
pub type PFN_glWindowPos3fMESA = unsafe extern "system" fn(_x: CoordF, _y: CoordF, _z: CoordF);
...
pub type PFN_glGetDoublei_vEXT =
    unsafe extern "system" fn(_pname: GetPName, _index: GLuint, _params: GLdouble);
...
pub type PFN_glMultiTexCoord2f =
    unsafe extern "system" fn(_target: TextureUnit, _s: CoordF, _t: CoordF);
pub type PFN_glColor3fv = unsafe extern "system" fn(_v: ColorF);
pub type PFN_glConvolutionParameterf = unsafe extern "system" fn(
    _target: ConvolutionTarget,
    _pname: ConvolutionParameterEXT,
    _params: CheckedFloat32,
);
pub type PFN_glMultiTexCoord1iv = unsafe extern "system" fn(_target: TextureUnit, _v: CoordI);
pub type PFN_glCreateShader = unsafe extern "system" fn(_type: ShaderType);
...
pub type PFN_glFogfv = unsafe extern "system" fn(_pname: FogParameter, _params: CheckedFloat32);
...
pub type PFN_glFogCoordf = unsafe extern "system" fn(_coord: CoordF);
...
pub type PFN_glLinkProgramARB = unsafe extern "system" fn(_programObj: handleARB);
...
pub type PFN_glRasterPos2d = unsafe extern "system" fn(_x: CoordD, _y: CoordD);
pub type PFN_glActiveTexture = unsafe extern "system" fn(_texture: TextureUnit);
pub type PFN_glGetTexParameterIivEXT =
    unsafe extern "system" fn(_target: TextureTarget, _pname: GetTextureParameter, _params: GLint);
...
pub type PFN_glGetQueryObjectuivEXT =
    unsafe extern "system" fn(_id: GLuint, _pname: QueryObjectParameterName, _params: GLuint);
pub type PFN_glRasterPos2fv = unsafe extern "system" fn(_v: CoordF);
...
pub type PFN_glSecondaryColor3iv = unsafe extern "system" fn(_v: ColorI);
pub type PFN_glMateriali =
    unsafe extern "system" fn(_face: MaterialFace, _pname: MaterialParameter, _param: CheckedInt32);
...
pub type PFN_glFogCoordfvEXT = unsafe extern "system" fn(_coord: CoordF);
pub type PFN_glIndexMask = unsafe extern "system" fn(_mask: MaskedColorIndexValueI);
...
pub type PFN_glGetClipPlane = unsafe extern "system" fn(_plane: ClipPlaneName, _equation: GLdouble);
...
pub type PFN_glGetnMapfvARB =
    unsafe extern "system" fn(_target: MapTarget, _query: MapQuery, _bufSize: GLsizei, _v: GLfloat);
...
pub type PFN_glTexCoord2hNV = unsafe extern "system" fn(_s: Half16NV, _t: Half16NV);
...
pub type PFN_glMultiTexCoord3sv = unsafe extern "system" fn(_target: TextureUnit, _v: CoordS);
pub type PFN_glTexCoord4fv = unsafe extern "system" fn(_v: CoordF);
...
pub type PFN_glMultiTexCoord3xvOES =
    unsafe extern "system" fn(_texture: TextureUnit, _coords: GLfixed);
...
pub type PFN_glColorMaski =
    unsafe extern "system" fn(_index: GLuint, _r: Boolean, _g: Boolean, _b: Boolean, _a: Boolean);
...
pub type PFN_glColor4us =
    unsafe extern "system" fn(_red: ColorUS, _green: ColorUS, _blue: ColorUS, _alpha: ColorUS);
...
pub type PFN_glGetPixelMapxv =
    unsafe extern "system" fn(_map: PixelMap, _size: GLint, _values: GLfixed);
...
pub type PFN_glNormal3d = unsafe extern "system" fn(_nx: CoordD, _ny: CoordD, _nz: CoordD);
...
pub type PFN_glWindowPos2f = unsafe extern "system" fn(_x: CoordF, _y: CoordF);
...
pub type PFN_glFenceSync =
    unsafe extern "system" fn(_condition: SyncCondition, _flags: SyncBehaviorFlags);
...
pub type PFN_glNormal3f = unsafe extern "system" fn(_nx: CoordF, _ny: CoordF, _nz: CoordF);
...
pub type PFN_glDebugMessageCallbackKHR =
    unsafe extern "system" fn(_callback: GLDEBUGPROCKHR, _userParam: GLvoid);
...
pub type PFN_glTexParameterIivEXT =
    unsafe extern "system" fn(_target: TextureTarget, _pname: TextureParameterName, _params: GLint);
pub type PFN_glProgramEnvParameter4fvARB =
    unsafe extern "system" fn(_target: ProgramTarget, _index: GLuint, _params: GLfloat);
...
pub type PFN_glMatrixMultTransposedEXT = unsafe extern "system" fn(_mode: MatrixMode, _m: GLdouble);
pub type PFN_glTexCoord1hvNV = unsafe extern "system" fn(_v: Half16NV);
pub type PFN_glGetFramebufferPixelLocalStorageSizeEXT =
    unsafe extern "system" fn(_target: FramebufferTarget);
pub type PFN_glGetVertexAttribfvARB =
    unsafe extern "system" fn(_index: GLuint, _pname: VertexAttribPropertyARB, _params: GLfloat);
pub type PFN_glGetTexParameterIivOES =
    unsafe extern "system" fn(_target: TextureTarget, _pname: GetTextureParameter, _params: GLint);
pub type PFN_glGetVertexAttribIiv =
    unsafe extern "system" fn(_index: GLuint, _pname: VertexAttribEnum, _params: GLint);
...
pub type PFN_glIndexiv = unsafe extern "system" fn(_c: ColorIndexValueI);
pub type PFN_glProgramParameter4dvNV =
    unsafe extern "system" fn(_target: VertexAttribEnumNV, _index: GLuint, _v: GLdouble);
pub type PFN_glDeformationMap3fSGIX = unsafe extern "system" fn(
    _target: FfdTargetSGIX,
    _u1: CoordF,
    _u2: CoordF,
    _ustride: GLint,
    _uorder: CheckedInt32,
    _v1: CoordF,
    _v2: CoordF,
    _vstride: GLint,
    _vorder: CheckedInt32,
    _w1: CoordF,
    _w2: CoordF,
    _wstride: GLint,
    _worder: CheckedInt32,
    _points: CoordF,
);
...
pub type PFN_glColor4ub =
    unsafe extern "system" fn(_red: ColorUB, _green: ColorUB, _blue: ColorUB, _alpha: ColorUB);
...
pub type PFN_glWindowPos2fv = unsafe extern "system" fn(_v: CoordF);
...
pub type PFN_glFogxvOES = unsafe extern "system" fn(_pname: FogPName, _param: GLfixed);
...
pub type PFN_glSemaphoreParameterivNV =
    unsafe extern "system" fn(_semaphore: GLuint, _pname: SemaphoreParameterName, _params: GLint);
pub type PFN_glEnablei = unsafe extern "system" fn(_target: EnableCap, _index: GLuint);
pub type PFN_glGetVertexAttribivNV =
    unsafe extern "system" fn(_index: GLuint, _pname: VertexAttribEnumNV, _params: GLint);
...
pub type PFN_glSecondaryColor3uiv = unsafe extern "system" fn(_v: ColorUI);
...
pub type PFN_glColorP4uiv = unsafe extern "system" fn(_type: ColorPointerType, _color: GLuint);
pub type PFN_glEvalPoint2 = unsafe extern "system" fn(_i: CheckedInt32, _j: CheckedInt32);
pub type PFN_glProgramUniform2i =
    unsafe extern "system" fn(_program: GLuint, _location: GLint, _v0: GLint, _v1: GLint);
pub type PFN_glGetIntegerv = unsafe extern "system" fn(_pname: GetPName, _data: GLint);
pub type PFN_glGlobalAlphaFactorfSUN = unsafe extern "system" fn(_factor: GLfloat);
pub type PFN_glSecondaryColor3usvEXT = unsafe extern "system" fn(_v: ColorUS);
...
pub type PFN_glSampleCoveragex = unsafe extern "system" fn(_value: GLclampx, _invert: Boolean);
pub type PFN_glTexCoord2hvNV = unsafe extern "system" fn(_v: Half16NV);
...
pub type PFN_glVertex3d = unsafe extern "system" fn(_x: CoordD, _y: CoordD, _z: CoordD);
...
pub type PFN_glGetDetailTexFuncSGIS =
    unsafe extern "system" fn(_target: TextureTarget, _points: GLfloat);
...
pub type PFN_glGetTexParameterIuivEXT =
    unsafe extern "system" fn(_target: TextureTarget, _pname: GetTextureParameter, _params: GLuint);
pub type PFN_glSecondaryColor3hNV =
    unsafe extern "system" fn(_red: Half16NV, _green: Half16NV, _blue: Half16NV);
...
pub type PFN_glFragmentLightModelfvSGIX =
    unsafe extern "system" fn(_pname: FragmentLightModelParameterSGIX, _params: CheckedFloat32);
...
pub type PFN_glGetVertexAttribLui64vNV =
    unsafe extern "system" fn(_index: GLuint, _pname: VertexAttribEnum, _params: GLuint64EXT);
...
pub type PFN_glMultiTexCoord1hvNV = unsafe extern "system" fn(_target: TextureUnit, _v: Half16NV);
pub type PFN_glSecondaryColorP3uiv =
    unsafe extern "system" fn(_type: ColorPointerType, _color: GLuint);
pub type PFN_glSampleCoveragexOES = unsafe extern "system" fn(_value: GLclampx, _invert: Boolean);
...
pub type PFN_glGetVertexAttribPointervNV =
    unsafe extern "system" fn(_index: GLuint, _pname: VertexAttribEnumNV, _pointer: GLvoid);
...
pub type PFN_glBinormal3dEXT = unsafe extern "system" fn(_bx: CoordD, _by: CoordD, _bz: CoordD);
pub type PFN_glFragmentLightModelivSGIX =
    unsafe extern "system" fn(_pname: FragmentLightModelParameterSGIX, _params: CheckedInt32);
pub type PFN_glGetTextureHandleNV = unsafe extern "system" fn(_texture: GLuint);
pub type PFN_glGetPointerv = unsafe extern "system" fn(_pname: GetPointervPName, _params: GLvoid);
...
pub type PFN_glTestFenceAPPLE = unsafe extern "system" fn(_fence: FenceNV);
pub type PFN_glGetObjectBufferfvATI =
    unsafe extern "system" fn(_buffer: GLuint, _pname: ArrayObjectPNameATI, _params: GLfloat);
...
pub type PFN_glMapGrid1f = unsafe extern "system" fn(_un: GLint, _u1: CoordF, _u2: CoordF);
pub type PFN_glTexCoord2bOES = unsafe extern "system" fn(_s: GLbyte, _t: GLbyte);
pub type PFN_glVDPAUUnregisterSurfaceNV = unsafe extern "system" fn(_surface: vdpauSurfaceNV);
...
pub type PFN_glPointSizePointerOES =
    unsafe extern "system" fn(_type: GLenum, _stride: GLsizei, _pointer: GLvoid);
pub type PFN_glGetPointeri_vEXT =
    unsafe extern "system" fn(_pname: GLenum, _index: GLuint, _params: GLvoid);
...
pub type PFN_glTexCoord3sv = unsafe extern "system" fn(_v: CoordS);
pub type PFN_glVertexStream3fvATI =
    unsafe extern "system" fn(_stream: VertexStreamATI, _coords: GLfloat);
...
pub type PFN_glGetOcclusionQueryuivNV =
    unsafe extern "system" fn(_id: GLuint, _pname: OcclusionQueryParameterNameNV, _params: GLuint);
...
pub type PFN_glStencilFillPathNV =
    unsafe extern "system" fn(_path: Path, _fillMode: PathFillMode, _mask: MaskedStencilValue);
...
pub type PFN_glNormal3hvNV = unsafe extern "system" fn(_v: Half16NV);
...
pub type PFN_glMultiTexEnvfEXT = unsafe extern "system" fn(
    ...
    _target: TextureEnvTarget,
    _pname: TextureEnvParameter,
    _param: CheckedFloat32,
);
pub type PFN_glVertexAttrib3hNV =
    unsafe extern "system" fn(_index: GLuint, _x: Half16NV, _y: Half16NV, _z: Half16NV);
pub type PFN_glPathStencilFuncNV = unsafe extern "system" fn(
    _func: StencilFunction,
    _ref: ClampedStencilValue,
    _mask: MaskedStencilValue,
);
pub type PFN_glWindowPos2sMESA = unsafe extern "system" fn(_x: CoordS, _y: CoordS);
pub type PFN_glGetPixelTexGenParameterfvSGIS =
    unsafe extern "system" fn(_pname: PixelTexGenParameterNameSGIS, _params: CheckedFloat32);
pub type PFN_glNormalStream3svATI =
    unsafe extern "system" fn(_stream: VertexStreamATI, _coords: GLshort);
pub type PFN_glWindowPos2fARB = unsafe extern "system" fn(_x: CoordF, _y: CoordF);
...
pub type PFN_glWindowPos2svARB = unsafe extern "system" fn(_v: CoordS);
...
pub type PFN_glStencilMaskSeparate =
    unsafe extern "system" fn(_face: StencilFaceDirection, _mask: MaskedStencilValue);
...
pub type PFN_glIsFenceNV = unsafe extern "system" fn(_fence: FenceNV);
pub type PFN_glFeedbackBuffer =
    unsafe extern "system" fn(_size: GLsizei, _type: FeedbackType, _buffer: FeedbackElement);
pub type PFN_glTangent3fEXT = unsafe extern "system" fn(_tx: CoordF, _ty: CoordF, _tz: CoordF);
...
pub type PFN_glLightModelfv =
    unsafe extern "system" fn(_pname: LightModelParameter, _params: GLfloat);
...
pub type PFN_glColor4i =
    unsafe extern "system" fn(_red: ColorI, _green: ColorI, _blue: ColorI, _alpha: ColorI);
...
pub type PFN_glGetMapdv =
    unsafe extern "system" fn(_target: MapTarget, _query: GetMapQuery, _v: GLdouble);
pub type PFN_glGetLightxvOES =
    unsafe extern "system" fn(_light: LightName, _pname: LightParameter, _params: GLfixed);
...
pub type PFN_glMultiTexCoord4iARB =
    unsafe extern "system" fn(_target: TextureUnit, _s: CoordI, _t: CoordI, _r: CoordI, _q: CoordI);
pub type PFN_glTextureColorMaskSGIS =
    unsafe extern "system" fn(_red: Boolean, _green: Boolean, _blue: Boolean, _alpha: Boolean);
pub type PFN_glTexCoord4sv = unsafe extern "system" fn(_v: CoordS);
...
pub type PFN_glVertex4d = unsafe extern "system" fn(_x: CoordD, _y: CoordD, _z: CoordD, _w: CoordD);
pub type PFN_glGetInteger64vEXT = unsafe extern "system" fn(_pname: GetPName, _data: GLint64);
...
pub type PFN_glTexEstimateMotionQCOM =
    unsafe extern "system" fn(_ref: Texture, _target: Texture, _output: Texture);
...
pub type PFN_glGetDoubleIndexedvEXT =
    unsafe extern "system" fn(_target: GetPName, _index: GLuint, _data: GLdouble);
pub type PFN_glMultiTexCoord4iv = unsafe extern "system" fn(_target: TextureUnit, _v: CoordI);
...
pub type PFN_glNormalStream3bvATI =
    unsafe extern "system" fn(_stream: VertexStreamATI, _coords: GLbyte);
pub type PFN_glPixelStoref =
    unsafe extern "system" fn(_pname: PixelStoreParameter, _param: CheckedFloat32);
...
pub type PFN_glVertexStream2svATI =
    unsafe extern "system" fn(_stream: VertexStreamATI, _coords: GLshort);
pub type PFN_glWindowPos3fARB = unsafe extern "system" fn(_x: CoordF, _y: CoordF, _z: CoordF);
pub type PFN_glColor4ubv = unsafe extern "system" fn(_v: ColorUB);
pub type PFN_glGetAttachedObjectsARB = unsafe extern "system" fn(
    _containerObj: handleARB,
    _maxCount: GLsizei,
    _count: GLsizei,
    _obj: handleARB,
);
pub type PFN_glCopyPathNV = unsafe extern "system" fn(_resultPath: Path, _srcPath: Path);
pub type PFN_glDisableVariantClientStateEXT = unsafe extern "system" fn(_id: GLuint);
pub type PFN_glExtGetBufferPointervQCOM =
    unsafe extern "system" fn(_target: GLenum, _params: GLvoid);
...
pub type PFN_glRectsv = unsafe extern "system" fn(_v1: CoordS, _v2: CoordS);
...
pub type PFN_glPatchParameterfv =
    unsafe extern "system" fn(_pname: PatchParameterName, _values: GLfloat);
...
pub type PFN_glGetProgramStringNV = unsafe extern "system" fn(
    _id: GLuint,
    _pname: VertexAttribEnumNV,
    _program: ProgramCharacterNV,
);
...
pub type PFN_glEvalCoord2d = unsafe extern "system" fn(_u: CoordD, _v: CoordD);
...
pub type PFN_glGetObjectParameterivARB =
    unsafe extern "system" fn(_obj: handleARB, _pname: GLenum, _params: GLint);
...
pub type PFN_glColor3ub = unsafe extern "system" fn(_red: ColorUB, _green: ColorUB, _blue: ColorUB);
pub type PFN_glFogCoordfEXT = unsafe extern "system" fn(_coord: CoordF);
...
pub type PFN_glTangent3dEXT = unsafe extern "system" fn(_tx: CoordD, _ty: CoordD, _tz: CoordD);
...
pub type PFN_glColor4usv = unsafe extern "system" fn(_v: ColorUS);
...
pub type PFN_glMultiTexCoord3fvARB = unsafe extern "system" fn(_target: TextureUnit, _v: CoordF);
...
pub type PFN_glColor4d =
    unsafe extern "system" fn(_red: ColorD, _green: ColorD, _blue: ColorD, _alpha: ColorD);
...
pub type PFN_glGetVariantIntegervEXT =
    unsafe extern "system" fn(_id: GLuint, _value: GetVariantValueEXT, _data: GLint);
...
pub type PFN_glMultiTexCoord4svARB = unsafe extern "system" fn(_target: TextureUnit, _v: CoordS);
...
pub type PFN_glTexCoord4s =
    unsafe extern "system" fn(_s: CoordS, _t: CoordS, _r: CoordS, _q: CoordS);
pub type PFN_glVertexStream1fvATI =
    unsafe extern "system" fn(_stream: VertexStreamATI, _coords: GLfloat);
pub type PFN_glPointParameterf =
    unsafe extern "system" fn(_pname: PointParameterNameARB, _param: CheckedFloat32);
pub type PFN_glTexCoord3dv = unsafe extern "system" fn(_v: CoordD);
pub type PFN_glBindMultiTextureEXT =
    unsafe extern "system" fn(_texunit: TextureUnit, _target: TextureTarget, _texture: Texture);
...
pub type PFN_glGetNamedBufferPointerv =
    unsafe extern "system" fn(_buffer: GLuint, _pname: BufferPointerNameARB, _params: GLvoid);
...
pub type PFN_glSecondaryColor3bvEXT = unsafe extern "system" fn(_v: ColorB);
pub type PFN_glVertexAttribI1iEXT = unsafe extern "system" fn(_index: GLuint, _x: GLint);
pub type PFN_glClearBufferuiv =
    unsafe extern "system" fn(_buffer: Buffer, _drawbuffer: DrawBufferName, _value: GLuint);
...
pub type PFN_glPointParameterivNV =
    unsafe extern "system" fn(_pname: PointParameterNameARB, _params: GLint);
...
pub type PFN_glTexParameteri = unsafe extern "system" fn(
    _target: TextureTarget,
    _pname: TextureParameterName,
    _param: CheckedInt32,
);
...
pub type PFN_glGetPointervEXT =
    unsafe extern "system" fn(_pname: GetPointervPName, _params: GLvoid);
...
pub type PFN_glElementPointerATI =
    unsafe extern "system" fn(_type: ElementPointerTypeATI, _pointer: GLvoid);
pub type PFN_glPushName = unsafe extern "system" fn(_name: SelectName);
pub type PFN_glVertexAttrib1dARB = unsafe extern "system" fn(_index: GLuint, _x: GLdouble);
pub type PFN_glCreateShaderProgramv =
    unsafe extern "system" fn(_type: ShaderType, _count: GLsizei, _strings: GLchar);
...
pub type PFN_glGetTextureParameterfv =
    unsafe extern "system" fn(_texture: GLuint, _pname: GetTextureParameter, _params: GLfloat);
pub type PFN_glDisableVertexAttribAPPLE = unsafe extern "system" fn(_index: GLuint, _pname: GLenum);
pub type PFN_glMatrixLoaddEXT = unsafe extern "system" fn(_mode: MatrixMode, _m: GLdouble);
...
pub type PFN_glMultiTexCoord2dv = unsafe extern "system" fn(_target: TextureUnit, _v: CoordD);
...
pub type PFN_glSecondaryColor3iEXT =
    unsafe extern "system" fn(_red: ColorI, _green: ColorI, _blue: ColorI);
...
pub type PFN_glNormal3hNV = unsafe extern "system" fn(_nx: Half16NV, _ny: Half16NV, _nz: Half16NV);
...
pub type PFN_glDeleteTextures = unsafe extern "system" fn(_n: GLsizei, _textures: Texture);
...
pub type PFN_glTextureFoveationParametersQCOM = unsafe extern "system" fn(
    ...
    _layer: GLuint,
    _focalPoint: GLuint,
    _focalX: CheckedFloat32,
    _focalY: CheckedFloat32,
    _gainX: CheckedFloat32,
    _gainY: CheckedFloat32,
    _foveaArea: CheckedFloat32,
);
...
pub type PFN_glVertexAttribs2hvNV =
    unsafe extern "system" fn(_index: GLuint, _n: GLsizei, _v: Half16NV);
pub type PFN_glListParameteriSGIX =
    unsafe extern "system" fn(_list: List, _pname: ListParameterName, _param: CheckedInt32);
...
pub type PFN_glVertex3hvNV = unsafe extern "system" fn(_v: Half16NV);
...
pub type PFN_glCoverStrokePathNV =
    unsafe extern "system" fn(_path: Path, _coverMode: PathCoverMode);
pub type PFN_glMultiTexCoord2d =
    unsafe extern "system" fn(_target: TextureUnit, _s: CoordD, _t: CoordD);
pub type PFN_glProgramUniform2uiv =
    unsafe extern "system" fn(_program: GLuint, _location: GLint, _count: GLsizei, _value: GLuint);
pub type PFN_glSetInvariantEXT =
    unsafe extern "system" fn(_id: GLuint, _type: ScalarType, _addr: GLvoid);
...
pub type PFN_glExecuteProgramNV =
    unsafe extern "system" fn(_target: VertexAttribEnumNV, _id: GLuint, _params: GLfloat);
pub type PFN_glGetBufferParameterui64vNV =
    unsafe extern "system" fn(_target: BufferTargetARB, _pname: GLenum, _params: GLuint64EXT);
pub type PFN_glGetFloati_vEXT =
    unsafe extern "system" fn(_pname: GetPName, _index: GLuint, _params: GLfloat);
pub type PFN_glMultiTexCoord1sv = unsafe extern "system" fn(_target: TextureUnit, _v: CoordS);
...
pub type PFN_glColor4sv = unsafe extern "system" fn(_v: ColorS);
...
pub type PFN_glFogxv = unsafe extern "system" fn(_pname: FogPName, _param: GLfixed);
...
pub type PFN_glLightiv =
    unsafe extern "system" fn(_light: LightName, _pname: LightParameter, _params: CheckedInt32);
...
pub type PFN_glGetMapParameterfvNV =
    unsafe extern "system" fn(_target: EvalTargetNV, _pname: MapParameterNV, _params: GLfloat);
...
pub type PFN_glBlendColorxOES = unsafe extern "system" fn(
    _red: ClampedFixed,
    _green: ClampedFixed,
    _blue: ClampedFixed,
    _alpha: ClampedFixed,
...
pub type PFN_glGetMaterialfv =
    unsafe extern "system" fn(_face: MaterialFace, _pname: MaterialParameter, _params: GLfloat);
pub type PFN_glProgramUniform1ui =
    unsafe extern "system" fn(_program: GLuint, _location: GLint, _v0: GLuint);
pub type PFN_glGetVariantBooleanvEXT =
    unsafe extern "system" fn(_id: GLuint, _value: GetVariantValueEXT, _data: Boolean);
...
pub type PFN_glPathParameterfNV =
    unsafe extern "system" fn(_path: Path, _pname: PathParameter, _value: GLfloat);
...
pub type PFN_glCreateSyncFromCLeventARB =
    unsafe extern "system" fn(_context: cl_context, _event: cl_event, _flags: GLbitfield);
...
pub type PFN_glNormal3fv = unsafe extern "system" fn(_v: CoordF);
...
pub type PFN_glWindowPos4sMESA =
    unsafe extern "system" fn(_x: CoordS, _y: CoordS, _z: CoordS, _w: CoordS);
...
pub type PFN_glGetBooleanIndexedvEXT =
    unsafe extern "system" fn(_target: BufferTargetARB, _index: GLuint, _data: Boolean);
pub type PFN_glColorMaskiOES =
    unsafe extern "system" fn(_index: GLuint, _r: Boolean, _g: Boolean, _b: Boolean, _a: Boolean);
...
pub type PFN_glMultiTexCoord4ivARB = unsafe extern "system" fn(_target: TextureUnit, _v: CoordI);
pub type PFN_glProgramUniform3uiv =
    unsafe extern "system" fn(_program: GLuint, _location: GLint, _count: GLsizei, _value: GLuint);
pub type PFN_glGetVertexAttribArrayObjectfvATI =
    unsafe extern "system" fn(_index: GLuint, _pname: ArrayObjectPNameATI, _params: GLfloat);
...
pub type PFN_glDrawBuffersARB = unsafe extern "system" fn(_n: GLsizei, _bufs: DrawBufferMode);
...
pub type PFN_glMultiTexCoord1iARB = unsafe extern "system" fn(_target: TextureUnit, _s: CoordI);
...
pub type PFN_glGetPixelMapfv = unsafe extern "system" fn(_map: PixelMap, _values: GLfloat);
pub type PFN_glMultiTexCoord1f = unsafe extern "system" fn(_target: TextureUnit, _s: CoordF);
pub type PFN_glTexBumpParameterivATI =
    unsafe extern "system" fn(_pname: TexBumpParameterATI, _param: GLint);
...
pub type PFN_glSecondaryColor3ubvEXT = unsafe extern "system" fn(_v: ColorUB);
...
pub type PFN_glSecondaryColor3hvNV = unsafe extern "system" fn(_v: Half16NV);
...
pub type PFN_glPixelDataRangeNV =
    unsafe extern "system" fn(_target: PixelDataRangeTargetNV, _length: GLsizei, _pointer: GLvoid);
...
pub type PFN_glPixelTransferi =
    unsafe extern "system" fn(_pname: PixelTransferParameter, _param: CheckedInt32);
...
pub type PFN_glGetPathParameterivNV =
    unsafe extern "system" fn(_path: Path, _pname: PathParameter, _value: GLint);
pub type PFN_glNormalP3ui = unsafe extern "system" fn(_type: NormalPointerType, _coords: GLuint);
pub type PFN_glFogCoorddEXT = unsafe extern "system" fn(_coord: CoordD);
...
pub type PFN_glImportSemaphoreWin32HandleEXT =
    unsafe extern "system" fn(_semaphore: GLuint, _handleType: ExternalHandleType, _handle: GLvoid);
...
pub type PFN_glNamedBufferSubData =
    unsafe extern "system" fn(_buffer: GLuint, _offset: GLintptr, _size: BufferSize, _data: GLvoid);
...
pub type PFN_glSecondaryColor3uivEXT = unsafe extern "system" fn(_v: ColorUI);
...
pub type PFN_glColor3bv = unsafe extern "system" fn(_v: ColorB);
...
pub type PFN_glUniformSubroutinesuiv =
    unsafe extern "system" fn(_shadertype: ShaderType, _count: GLsizei, _indices: GLuint);
...
pub type PFN_glDiscardFramebufferEXT = unsafe extern "system" fn(
    _target: FramebufferTarget,
    _numAttachments: GLsizei,
    _attachments: InvalidateFramebufferAttachment,
);
...
pub type PFN_glClearStencil = unsafe extern "system" fn(_s: StencilValue);
...
pub type PFN_glGetCompressedTextureImage =
    unsafe extern "system" fn(_texture: GLuint, _level: GLint, _bufSize: GLsizei, _pixels: GLvoid);
...
pub type PFN_glDepthRangefOES = unsafe extern "system" fn(_n: ClampedFloat32, _f: ClampedFloat32);
...
pub type PFN_glRasterPos4dv = unsafe extern "system" fn(_v: CoordD);
...
pub type PFN_glGetFixedv = unsafe extern "system" fn(_pname: GetPName, _params: GLfixed);
pub type PFN_glGenTransformFeedbacks = unsafe extern "system" fn(_n: GLsizei, _ids: GLuint);
pub type PFN_glMultiTexCoord4d =
    unsafe extern "system" fn(_target: TextureUnit, _s: CoordD, _t: CoordD, _r: CoordD, _q: CoordD);
...
pub type PFN_glGetPathColorGenivNV =
    unsafe extern "system" fn(_color: PathColor, _pname: PathGenMode, _value: GLint);
...
pub type PFN_glWindowPos4dMESA =
    unsafe extern "system" fn(_x: CoordD, _y: CoordD, _z: CoordD, _w: CoordD);
...
pub type PFN_glVDPAUSurfaceAccessNV =
    unsafe extern "system" fn(_surface: vdpauSurfaceNV, _access: GLenum);
pub type PFN_glWindowPos2fMESA = unsafe extern "system" fn(_x: CoordF, _y: CoordF);
pub type PFN_glClearColorIuiEXT =
    unsafe extern "system" fn(_red: GLuint, _green: GLuint, _blue: GLuint, _alpha: GLuint);
pub type PFN_glMultiTexCoord4dv = unsafe extern "system" fn(_target: TextureUnit, _v: CoordD);
...
pub type PFN_glDepthRangeArrayfvNV =
    unsafe extern "system" fn(_first: GLuint, _count: GLsizei, _v: GLfloat);
pub type PFN_glGetPixelMapusv = unsafe extern "system" fn(_map: PixelMap, _values: GLushort);
...
pub type PFN_glIsFenceAPPLE = unsafe extern "system" fn(_fence: FenceNV);
...
pub type PFN_glGetBufferParameteriv =
    unsafe extern "system" fn(_target: BufferTargetARB, _pname: BufferPNameARB, _params: GLint);
...
pub type PFN_glUniform1fv =
    unsafe extern "system" fn(_location: GLint, _count: GLsizei, _value: GLfloat);
pub type PFN_glValidateProgramARB = unsafe extern "system" fn(_programObj: handleARB);
pub type PFN_glInterleavedArrays =
    unsafe extern "system" fn(_format: InterleavedArrayFormat, _stride: GLsizei, _pointer: GLvoid);
...
pub type PFN_glBindTexture = unsafe extern "system" fn(_target: TextureTarget, _texture: Texture);
...
pub type PFN_glTexCoord2d = unsafe extern "system" fn(_s: CoordD, _t: CoordD);
...
pub type PFN_glReplacementCodeuiVertex3fvSUN =
    unsafe extern "system" fn(_rc: ReplacementCodeSUN, _v: GLfloat);
...
pub type PFN_glVertexAttribs4ubvNV =
    unsafe extern "system" fn(_index: GLuint, _count: GLsizei, _v: ColorUB);
...
pub type PFN_glPassThrough = unsafe extern "system" fn(_token: FeedbackElement);
pub type PFN_glWindowPos2dvARB = unsafe extern "system" fn(_v: CoordD);
pub type PFN_glTexGenfOES = unsafe extern "system" fn(
    _coord: TextureCoordName,
    _pname: TextureGenParameter,
    _param: GLfloat,
);
pub type PFN_glRasterPos4sv = unsafe extern "system" fn(_v: CoordS);
...
pub type PFN_glCheckFramebufferStatus = unsafe extern "system" fn(_target: FramebufferTarget);
pub type PFN_glVertex4fv = unsafe extern "system" fn(_v: CoordF);
...
pub type PFN_glTexCoord1dv = unsafe extern "system" fn(_v: CoordD);
...
pub type PFN_glEvalCoord1d = unsafe extern "system" fn(_u: CoordD);
...
pub type PFN_glGetPathTexGenivNV =
    unsafe extern "system" fn(_texCoordSet: TextureUnit, _pname: PathGenMode, _value: GLint);
...
pub type PFN_glFogCoordfv = unsafe extern "system" fn(_coord: CoordF);
...
pub type PFN_glUniform1uiv =
    unsafe extern "system" fn(_location: GLint, _count: GLsizei, _value: GLuint);
pub type PFN_glVertex3iv = unsafe extern "system" fn(_v: CoordI);
pub type PFN_glDepthBoundsEXT =
    unsafe extern "system" fn(_zmin: ClampedFloat64, _zmax: ClampedFloat64);
...
pub type PFN_glIndexPointer =
    unsafe extern "system" fn(_type: IndexPointerType, _stride: GLsizei, _pointer: GLvoid);
...
pub type PFN_glGetObjectPtrLabelKHR =
    unsafe extern "system" fn(_ptr: GLvoid, _bufSize: GLsizei, _length: GLsizei, _label: GLchar);
...
pub type PFN_glGetFloatv = unsafe extern "system" fn(_pname: GetPName, _data: GLfloat);
...
pub type PFN_glEdgeFlagPointerEXT =
    unsafe extern "system" fn(_stride: GLsizei, _count: GLsizei, _pointer: Boolean);
...
pub type PFN_glGetUniformivARB =
    unsafe extern "system" fn(_programObj: handleARB, _location: GLint, _params: GLint);
...
pub type PFN_glGetVertexArrayIntegervEXT =
    unsafe extern "system" fn(_vaobj: GLuint, _pname: VertexArrayPName, _param: GLint);
pub type PFN_glVertexAttrib3fv = unsafe extern "system" fn(_index: GLuint, _v: GLfloat);
pub type PFN_glScissorExclusiveNV =
    unsafe extern "system" fn(_x: WinCoord, _y: WinCoord, _width: GLsizei, _height: GLsizei);
...
pub type PFN_glBlendEquationSeparateOES =
    unsafe extern "system" fn(_modeRGB: BlendEquationModeEXT, _modeAlpha: BlendEquationModeEXT);
pub type PFN_glCoverFillPathNV = unsafe extern "system" fn(_path: Path, _coverMode: PathCoverMode);
pub type PFN_glVertex2sv = unsafe extern "system" fn(_v: CoordS);
...
pub type PFN_glRectiv = unsafe extern "system" fn(_v1: CoordI, _v2: CoordI);
...
pub type PFN_glWindowPos3svARB = unsafe extern "system" fn(_v: CoordS);
pub type PFN_glDetailTexFuncSGIS =
    unsafe extern "system" fn(_target: TextureTarget, _n: GLsizei, _points: GLfloat);
pub type PFN_glGetPathColorGenfvNV =
    unsafe extern "system" fn(_color: PathColor, _pname: PathGenMode, _value: GLfloat);
...
pub type PFN_glTexCoord4i =
    unsafe extern "system" fn(_s: CoordI, _t: CoordI, _r: CoordI, _q: CoordI);
...
pub type PFN_glCullParameterdvEXT =
    unsafe extern "system" fn(_pname: CullParameterEXT, _params: GLdouble);
pub type PFN_glGetConvolutionParameterxvOES =
    unsafe extern "system" fn(_target: GLenum, _pname: GLenum, _params: GLfixed);
pub type PFN_glGetClipPlanef = unsafe extern "system" fn(_plane: ClipPlaneName, _equation: GLfloat);
pub type PFN_glGetnPixelMapfv =
    unsafe extern "system" fn(_map: PixelMap, _bufSize: GLsizei, _values: GLfloat);
...
pub type PFN_glVertex3hNV = unsafe extern "system" fn(_x: Half16NV, _y: Half16NV, _z: Half16NV);
...
pub type PFN_glGetDoublev = unsafe extern "system" fn(_pname: GetPName, _data: GLdouble);
...
pub type PFN_glTexCoord2sv = unsafe extern "system" fn(_v: CoordS);
...
pub type PFN_glGetNamedBufferPointervEXT =
    unsafe extern "system" fn(_buffer: GLuint, _pname: BufferPointerNameARB, _params: GLvoid);
pub type PFN_glDispatchComputeIndirect = unsafe extern "system" fn(_indirect: BufferOffset);
pub type PFN_glAttachObjectARB =
    unsafe extern "system" fn(_containerObj: handleARB, _obj: handleARB);
pub type PFN_glGetPathTexGenfvNV =
    unsafe extern "system" fn(_texCoordSet: TextureUnit, _pname: PathGenMode, _value: GLfloat);
...
pub type PFN_glPrioritizeTextures =
    unsafe extern "system" fn(_n: GLsizei, _textures: Texture, _priorities: GLfloat);
pub type PFN_glRecti =
    unsafe extern "system" fn(_x1: CoordI, _y1: CoordI, _x2: CoordI, _y2: CoordI);
...
pub type PFN_glColor4b =
    unsafe extern "system" fn(_red: ColorB, _green: ColorB, _blue: ColorB, _alpha: ColorB);
pub type PFN_glGetUnsignedBytevEXT = unsafe extern "system" fn(_pname: GetPName, _data: GLubyte);
pub type PFN_glProgramUniform2d =
    unsafe extern "system" fn(_program: GLuint, _location: GLint, _v0: GLdouble, _v1: GLdouble);
pub type PFN_glSecondaryColor3dv = unsafe extern "system" fn(_v: ColorD);
...
pub type PFN_glClearBufferfv =
    unsafe extern "system" fn(_buffer: Buffer, _drawbuffer: DrawBufferName, _value: GLfloat);
pub type PFN_glGetQueryObjectivEXT =
    unsafe extern "system" fn(_id: GLuint, _pname: QueryObjectParameterName, _params: GLint);
...
pub type PFN_glMultiTexCoord2sv = unsafe extern "system" fn(_target: TextureUnit, _v: CoordS);
...
pub type PFN_glColor3iv = unsafe extern "system" fn(_v: ColorI);
pub type PFN_glPixelMapusv =
    unsafe extern "system" fn(_map: PixelMap, _mapsize: CheckedInt32, _values: GLushort);
...
pub type PFN_glMultiTexCoord3sARB =
    unsafe extern "system" fn(_target: TextureUnit, _s: CoordS, _t: CoordS, _r: CoordS);
pub type PFN_glDisableVertexAttribArray = unsafe extern "system" fn(_index: GLuint);
pub type PFN_glGetTexBumpParameterivATI =
    unsafe extern "system" fn(_pname: GetTexBumpParameterATI, _param: GLint);
...
pub type PFN_glMaterialf = unsafe extern "system" fn(
    _face: MaterialFace,
    _pname: MaterialParameter,
    _param: CheckedFloat32,
);
...
pub type PFN_glCombinerParameterfvNV =
    unsafe extern "system" fn(_pname: CombinerParameterNV, _params: CheckedFloat32);
pub type PFN_glGetProgramResourceLocationIndex =
    unsafe extern "system" fn(_program: GLuint, _programInterface: ProgramInterface, _name: GLchar);
...
pub type PFN_glIndexd = unsafe extern "system" fn(_c: ColorIndexValueD);
...
pub type PFN_glAreTexturesResidentEXT =
    unsafe extern "system" fn(_n: GLsizei, _textures: Texture, _residences: Boolean);
pub type PFN_glResolveMultisampleFramebufferAPPLE = unsafe extern "system" fn();
pub type PFN_glTexCoord1f = unsafe extern "system" fn(_s: CoordF);
...
pub type PFN_TexStorageAttribs3DEXT = unsafe extern "system" fn(
    ...
    _height: GLsizei,
    _depth: GLsizei,
    _attrib_list: TexStorageAttribs,
);
pub type PFN_glVertex3i = unsafe extern "system" fn(_x: CoordI, _y: CoordI, _z: CoordI);
...
pub type PFN_glAccum = unsafe extern "system" fn(_op: AccumOp, _value: CoordF);
...
pub type PFN_glMultiTexCoord3f =
    unsafe extern "system" fn(_target: TextureUnit, _s: CoordF, _t: CoordF, _r: CoordF);
pub type PFN_glGetArrayObjectfvATI =
    unsafe extern "system" fn(_array: EnableCap, _pname: ArrayObjectPNameATI, _params: GLfloat);
...
pub type PFN_glListParameterivSGIX =
    unsafe extern "system" fn(_list: List, _pname: ListParameterName, _params: CheckedInt32);
pub type PFN_glSecondaryColor3sv = unsafe extern "system" fn(_v: ColorS);
...
pub type PFN_glVertex4i = unsafe extern "system" fn(_x: CoordI, _y: CoordI, _z: CoordI, _w: CoordI);
...
pub type PFN_glFlushVertexArrayRangeAPPLE =
    unsafe extern "system" fn(_length: GLsizei, _pointer: GLvoid);
pub type PFN_glDrawBuffersATI = unsafe extern "system" fn(_n: GLsizei, _bufs: DrawBufferMode);
pub type PFN_glBlendFunciEXT =
    unsafe extern "system" fn(_buf: GLuint, _src: BlendingFactor, _dst: BlendingFactor);
pub type PFN_glGetFixedvOES = unsafe extern "system" fn(_pname: GetPName, _params: GLfixed);
...
pub type PFN_glTexCoordPointervINTEL =
    unsafe extern "system" fn(_size: GLint, _type: VertexPointerType, _pointer: GLvoid);
...
pub type PFN_glMultiTexCoord2hNV =
    unsafe extern "system" fn(_target: TextureUnit, _s: Half16NV, _t: Half16NV);
pub type PFN_glVertex2dv = unsafe extern "system" fn(_v: CoordD);
...
pub type PFN_glGetProgramEnvParameterdvARB =
    unsafe extern "system" fn(_target: ProgramTarget, _index: GLuint, _params: GLdouble);
...
pub type PFN_glGetVertexAttribfvNV =
    unsafe extern "system" fn(_index: GLuint, _pname: VertexAttribEnumNV, _params: GLfloat);
...
pub type PFN_glGenTexturesEXT = unsafe extern "system" fn(_n: GLsizei, _textures: Texture);
...
pub type PFN_glWindowPos2dvMESA = unsafe extern "system" fn(_v: CoordD);
...
pub type PFN_glGetVariantPointervEXT =
    unsafe extern "system" fn(_id: GLuint, _value: GetVariantValueEXT, _data: GLvoid);
...
pub type PFN_glWindowPos3ivMESA = unsafe extern "system" fn(_v: CoordI);
pub type PFN_glMultiTexCoord4hvNV = unsafe extern "system" fn(_target: TextureUnit, _v: Half16NV);
pub type PFN_glIsSync = unsafe extern "system" fn(_sync: sync);
...
pub type PFN_glMultiTexCoord3dvARB = unsafe extern "system" fn(_target: TextureUnit, _v: CoordD);
pub type PFN_glLoadTransposeMatrixf = unsafe extern "system" fn(_m: GLfloat);
pub type PFN_glNamedFramebufferDrawBuffers =
    unsafe extern "system" fn(_framebuffer: GLuint, _n: GLsizei, _bufs: ColorBuffer);
pub type PFN_glPointParameterxv =
    unsafe extern "system" fn(_pname: PointParameterNameARB, _params: GLfixed);
pub type PFN_glRasterPos2iv = unsafe extern "system" fn(_v: CoordI);
...
pub type PFN_glGetLocalConstantFloatvEXT =
    unsafe extern "system" fn(_id: GLuint, _value: GetVariantValueEXT, _data: GLfloat);
...
pub type PFN_glGetInvariantIntegervEXT =
    unsafe extern "system" fn(_id: GLuint, _value: GetVariantValueEXT, _data: GLint);
pub type PFN_glClearIndex = unsafe extern "system" fn(_c: MaskedColorIndexValueF);
pub type PFN_glDeleteVertexShaderEXT = unsafe extern "system" fn(_id: GLuint);
pub type PFN_glClearDepthfOES = unsafe extern "system" fn(_depth: ClampedFloat32);
pub type PFN_glGetQueryiv =
    unsafe extern "system" fn(_target: QueryTarget, _pname: QueryParameterName, _params: GLint);
...
pub type PFN_glMultiTexCoord3fv = unsafe extern "system" fn(_target: TextureUnit, _v: CoordF);
pub type PFN_glColorMask =
    unsafe extern "system" fn(_red: Boolean, _green: Boolean, _blue: Boolean, _alpha: Boolean);
pub type PFN_glViewportIndexedfNV =
    unsafe extern "system" fn(_index: GLuint, _x: GLfloat, _y: GLfloat, _w: GLfloat, _h: GLfloat);
pub type PFN_glVertex4sv = unsafe extern "system" fn(_v: CoordS);
...
pub type PFN_glMultiTexCoord3iARB =
    unsafe extern "system" fn(_target: TextureUnit, _s: CoordI, _t: CoordI, _r: CoordI);
...
pub type PFN_glProgramParameter4fvNV =
    unsafe extern "system" fn(_target: VertexAttribEnumNV, _index: GLuint, _v: GLfloat);
...
pub type PFN_glSamplerParameterIivOES =
    unsafe extern "system" fn(_sampler: GLuint, _pname: SamplerParameterI, _param: GLint);
pub type PFN_glCoverageMaskNV = unsafe extern "system" fn(_mask: Boolean);
pub type PFN_glClearDepthxOES = unsafe extern "system" fn(_depth: ClampedFixed);
...
pub type PFN_glClipPlanexIMG = unsafe extern "system" fn(_p: ClipPlaneName, _eqn: GLfixed);
...
pub type PFN_glVDPAUUnmapSurfacesNV =
    unsafe extern "system" fn(_numSurface: GLsizei, _surfaces: vdpauSurfaceNV);
pub type PFN_glVertex2d = unsafe extern "system" fn(_x: CoordD, _y: CoordD);
pub type PFN_glSecondaryColor3fEXT =
    unsafe extern "system" fn(_red: ColorF, _green: ColorF, _blue: ColorF);
...
pub type PFN_glGetBooleanv = unsafe extern "system" fn(_pname: GetPName, _data: Boolean);
...
pub type PFN_glMultiTexCoord2s =
    unsafe extern "system" fn(_target: TextureUnit, _s: CoordS, _t: CoordS);
...
pub type PFN_glGetQueryObjecti64v =
    unsafe extern "system" fn(_id: GLuint, _pname: QueryObjectParameterName, _params: GLint64);
...
pub type PFN_glDrawElementArrayAPPLE =
    unsafe extern "system" fn(_mode: PrimitiveType, _first: GLint, _count: GLsizei);
pub type PFN_glVertex2f = unsafe extern "system" fn(_x: CoordF, _y: CoordF);
...
pub type PFN_glWeightPointerOES =
    unsafe extern "system" fn(_size: GLint, _type: GLenum, _stride: GLsizei, _pointer: GLvoid);
...
pub type PFN_glReplacementCodeuiColor4ubVertex3fvSUN =
    unsafe extern "system" fn(_rc: ReplacementCodeSUN, _c: GLubyte, _v: GLfloat);
pub type PFN_glSecondaryColor3ub =
    unsafe extern "system" fn(_red: ColorUB, _green: ColorUB, _blue: ColorUB);
...
pub type PFN_glMultiTexCoord2iARB =
    unsafe extern "system" fn(_target: TextureUnit, _s: CoordI, _t: CoordI);
...
pub type PFN_glGetSamplerParameterIiv =
    unsafe extern "system" fn(_sampler: GLuint, _pname: SamplerParameterI, _params: GLint);
...
pub type PFN_glGetnCompressedTexImageARB =
    unsafe extern "system" fn(_target: TextureTarget, _lod: GLint, _bufSize: GLsizei, _img: GLvoid);
pub type PFN_glColor3sv = unsafe extern "system" fn(_v: ColorS);
pub type PFN_glGetDriverControlsQCOM =
    unsafe extern "system" fn(_num: GLint, _size: GLsizei, _driverControls: GLuint);
pub type PFN_glUnmapBufferARB = unsafe extern "system" fn(_target: BufferTargetARB);
...
pub type PFN_glWindowPos3iv = unsafe extern "system" fn(_v: CoordI);
...
pub type PFN_glTangent3dvEXT = unsafe extern "system" fn(_v: CoordD);
pub type PFN_glNormalPointer =
    unsafe extern "system" fn(_type: NormalPointerType, _stride: GLsizei, _pointer: GLvoid);
...
pub type PFN_glSamplerParameterIuiv =
    unsafe extern "system" fn(_sampler: GLuint, _pname: SamplerParameterI, _param: GLuint);
...
pub type PFN_glIndexfv = unsafe extern "system" fn(_c: ColorIndexValueF);
pub type PFN_glTexCoord2fColor4fNormal3fVertex3fvSUN =
    unsafe extern "system" fn(_tc: GLfloat, _c: GLfloat, _n: GLfloat, _v: GLfloat);
pub type PFN_glWindowPos3dvARB = unsafe extern "system" fn(_v: CoordD);
pub type PFN_glIndexi = unsafe extern "system" fn(_c: ColorIndexValueI);
pub type PFN_glTexCoord1fv = unsafe extern "system" fn(_v: CoordF);
...
pub type PFN_glMultiTexCoord1fvARB = unsafe extern "system" fn(_target: TextureUnit, _v: CoordF);
pub type PFN_glSamplerParameterf =
    unsafe extern "system" fn(_sampler: GLuint, _pname: SamplerParameterF, _param: GLfloat);
pub type PFN_glTangent3fvEXT = unsafe extern "system" fn(_v: CoordF);
pub type PFN_glViewport =
    unsafe extern "system" fn(_x: WinCoord, _y: WinCoord, _width: GLsizei, _height: GLsizei);
pub type PFN_glWindowPos3f = unsafe extern "system" fn(_x: CoordF, _y: CoordF, _z: CoordF);
...
pub type PFN_glListBase = unsafe extern "system" fn(_base: List);
pub type PFN_glMultiTexCoord4bvOES =
    unsafe extern "system" fn(_texture: TextureUnit, _coords: GLbyte);
pub type PFN_glWindowPos2svMESA = unsafe extern "system" fn(_v: CoordS);
...
pub type PFN_glGetVertexArrayPointervEXT =
    unsafe extern "system" fn(_vaobj: GLuint, _pname: VertexArrayPName, _param: GLvoid);
...
pub type PFN_glMapBufferOES =
    unsafe extern "system" fn(_target: BufferTargetARB, _access: BufferAccessARB);
...
pub type PFN_glGetTextureParameterIiv =
    unsafe extern "system" fn(_texture: GLuint, _pname: GetTextureParameter, _params: GLint);
pub type PFN_glRasterPos3s = unsafe extern "system" fn(_x: CoordS, _y: CoordS, _z: CoordS);
...
pub type PFN_glTexCoord1iv = unsafe extern "system" fn(_v: CoordI);
...
pub type PFN_glSetFenceNV =
    unsafe extern "system" fn(_fence: FenceNV, _condition: FenceConditionNV);
...
pub type PFN_glCullParameterfvEXT =
    unsafe extern "system" fn(_pname: CullParameterEXT, _params: GLfloat);
...
pub type PFN_glGetClipPlanexOES =
    unsafe extern "system" fn(_plane: ClipPlaneName, _equation: GLfixed);
...
pub type PFN_glMultiTexCoord4dvARB = unsafe extern "system" fn(_target: TextureUnit, _v: CoordD);
...
pub type PFN_glFinishFenceAPPLE = unsafe extern "system" fn(_fence: FenceNV);
...
pub type PFN_glGetNamedBufferParameteriv =
    unsafe extern "system" fn(_buffer: GLuint, _pname: BufferPNameARB, _params: GLint);
pub type PFN_glRectf =
    unsafe extern "system" fn(_x1: CoordF, _y1: CoordF, _x2: CoordF, _y2: CoordF);
pub type PFN_glGetPointerIndexedvEXT =
    unsafe extern "system" fn(_target: GLenum, _index: GLuint, _data: GLvoid);
...
pub type PFN_glTexCoord4hNV =
    unsafe extern "system" fn(_s: Half16NV, _t: Half16NV, _r: Half16NV, _q: Half16NV);
...
pub type PFN_glSampleMaskEXT = unsafe extern "system" fn(_value: ClampedFloat32, _invert: Boolean);
pub type PFN_glSecondaryColor3bv = unsafe extern "system" fn(_v: ColorB);
...
pub type PFN_glGetnMapiv =
    unsafe extern "system" fn(_target: MapTarget, _query: MapQuery, _bufSize: GLsizei, _v: GLint);
...
pub type PFN_glColor3dv = unsafe extern "system" fn(_v: ColorD);
pub type PFN_glLightEnviSGIX =
    unsafe extern "system" fn(_pname: LightEnvParameterSGIX, _param: CheckedInt32);
pub type PFN_glResumeTransformFeedbackNV = unsafe extern "system" fn();
pub type PFN_glShaderSourceARB = unsafe extern "system" fn(
    _shaderObj: handleARB,
    _count: GLsizei,
    _string: GLcharARB,
    _length: GLint,
);
...
pub type PFN_glClipPlanefIMG = unsafe extern "system" fn(_p: ClipPlaneName, _eqn: GLfloat);
...
pub type PFN_glVertexAttribs4hvNV =
    unsafe extern "system" fn(_index: GLuint, _n: GLsizei, _v: Half16NV);
pub type PFN_glWindowPos2d = unsafe extern "system" fn(_x: CoordD, _y: CoordD);
pub type PFN_glProgramEnvParameterI4ivNV =
    unsafe extern "system" fn(_target: ProgramTarget, _index: GLuint, _params: GLint);
...
pub type PFN_glFlushMappedBufferRange =
    unsafe extern "system" fn(_target: BufferTargetARB, _offset: BufferOffset, _length: BufferSize);
...
pub type PFN_glTexCoord3d = unsafe extern "system" fn(_s: CoordD, _t: CoordD, _r: CoordD);
...
pub type PFN_glTexCoordP2ui =
    unsafe extern "system" fn(_type: TexCoordPointerType, _coords: GLuint);
pub type PFN_glFogf = unsafe extern "system" fn(_pname: FogParameter, _param: CheckedFloat32);
pub type PFN_glVertexAttribs4dvNV =
    unsafe extern "system" fn(_index: GLuint, _count: GLsizei, _v: GLdouble);
pub type PFN_glDeleteSync = unsafe extern "system" fn(_sync: sync);
...
pub type PFN_glIsPointInFillPathNV =
    unsafe extern "system" fn(_path: Path, _mask: MaskedStencilValue, _x: GLfloat, _y: GLfloat);
pub type PFN_glProgramUniform3uivEXT =
    unsafe extern "system" fn(_program: GLuint, _location: GLint, _count: GLsizei, _value: GLuint);
pub type PFN_glWindowPos2ivMESA = unsafe extern "system" fn(_v: CoordI);
pub type PFN_glPixelStorei =
    unsafe extern "system" fn(_pname: PixelStoreParameter, _param: CheckedInt32);
pub type PFN_glNewList = unsafe extern "system" fn(_list: List, _mode: ListMode);
pub type PFN_glAreProgramsResidentNV =
    unsafe extern "system" fn(_n: GLsizei, _programs: GLuint, _residences: Boolean);
...
pub type PFN_glClipPlanex = unsafe extern "system" fn(_plane: ClipPlaneName, _equation: GLfixed);
...
pub type PFN_glTexCoord3f = unsafe extern "system" fn(_s: CoordF, _t: CoordF, _r: CoordF);
pub type PFN_glSecondaryColor3dEXT =
    unsafe extern "system" fn(_red: ColorD, _green: ColorD, _blue: ColorD);
...
pub type PFN_glProgramUniform4i64vARB =
    unsafe extern "system" fn(_program: GLuint, _location: GLint, _count: GLsizei, _value: GLint64);
pub type PFN_glSampleMaskSGIS = unsafe extern "system" fn(_value: ClampedFloat32, _invert: Boolean);
...
pub type PFN_glWindowPos2iARB = unsafe extern "system" fn(_x: CoordI, _y: CoordI);
pub type PFN_glColor4ubVertex3fvSUN = unsafe extern "system" fn(_c: GLubyte, _v: GLfloat);
pub type PFN_glVertex2fv = unsafe extern "system" fn(_v: CoordF);
...
pub type PFN_glLightf =
    unsafe extern "system" fn(_light: LightName, _pname: LightParameter, _param: CheckedFloat32);
...
pub type PFN_glMultiTexCoord4fvARB = unsafe extern "system" fn(_target: TextureUnit, _v: CoordF);
...
pub type PFN_glRasterPos2sv = unsafe extern "system" fn(_v: CoordS);
pub type PFN_glVertexBlendARB = unsafe extern "system" fn(_count: GLint);
pub type PFN_glVariantPointerEXT =
    unsafe extern "system" fn(_id: GLuint, _type: ScalarType, _stride: GLuint, _addr: GLvoid);
pub type PFN_glCheckNamedFramebufferStatusEXT =
    unsafe extern "system" fn(_framebuffer: Framebuffer, _target: FramebufferTarget);
pub type PFN_glEndQuery = unsafe extern "system" fn(_target: QueryTarget);
pub type PFN_glVertexArrayRangeNV = unsafe extern "system" fn(_length: GLsizei, _pointer: GLvoid);
...
pub type PFN_glPathDashArrayNV =
    unsafe extern "system" fn(_path: Path, _dashCount: GLsizei, _dashArray: GLfloat);
...
pub type PFN_glReplacementCodeuiColor3fVertex3fvSUN =
    unsafe extern "system" fn(_rc: ReplacementCodeSUN, _c: GLfloat, _v: GLfloat);
...
pub type PFN_glGetUniformSubroutineuiv =
    unsafe extern "system" fn(_shadertype: ShaderType, _location: GLint, _params: GLuint);
...
pub type PFN_glSecondaryColor3usv = unsafe extern "system" fn(_v: ColorUS);
pub type PFN_glRectfv = unsafe extern "system" fn(_v1: CoordF, _v2: CoordF);
...
pub type PFN_glTexCoord2f = unsafe extern "system" fn(_s: CoordF, _t: CoordF);
pub type PFN_glUniform3fv =
    unsafe extern "system" fn(_location: GLint, _count: GLsizei, _value: GLfloat);
pub type PFN_glVertex2i = unsafe extern "system" fn(_x: CoordI, _y: CoordI);
...
pub type PFN_glDeleteLists = unsafe extern "system" fn(_list: List, _range: GLsizei);
pub type PFN_glColor4bv = unsafe extern "system" fn(_v: ColorB);
...
pub type PFN_glWindowPos3d = unsafe extern "system" fn(_x: CoordD, _y: CoordD, _z: CoordD);
...
pub type PFN_glTexCoord2fv = unsafe extern "system" fn(_v: CoordF);
pub type PFN_glRasterSamplesEXT =
    unsafe extern "system" fn(_samples: GLuint, _fixedsamplelocations: Boolean);
...
pub type PFN_glTexCoord4iv = unsafe extern "system" fn(_v: CoordI);
pub type PFN_glProgramEnvParameterI4uivNV =
    unsafe extern "system" fn(_target: ProgramTarget, _index: GLuint, _params: GLuint);
pub type PFN_glGenTextures = unsafe extern "system" fn(_n: GLsizei, _textures: Texture);
pub type PFN_glTexCoord2bvOES = unsafe extern "system" fn(_coords: GLbyte);
pub type PFN_glRasterPos3d = unsafe extern "system" fn(_x: CoordD, _y: CoordD, _z: CoordD);
pub type PFN_glUniform3ivARB =
    unsafe extern "system" fn(_location: GLint, _count: GLsizei, _value: GLint);
pub type PFN_glStencilFunc = unsafe extern "system" fn(
    _func: StencilFunction,
    _ref: StencilValue,
    _mask: MaskedStencilValue,
);
pub type PFN_glGetUniformfvARB =
    unsafe extern "system" fn(_programObj: handleARB, _location: GLint, _params: GLfloat);
...
pub type PFN_glProgramParameteriEXT =
    unsafe extern "system" fn(_program: GLuint, _pname: ProgramParameterPName, _value: GLint);
pub type PFN_glFragmentMaterialfSGIX = unsafe extern "system" fn(
    _face: MaterialFace,
    _pname: MaterialParameter,
    _param: CheckedFloat32,
);
...
pub type PFN_glGetShaderiv =
    unsafe extern "system" fn(_shader: GLuint, _pname: ShaderParameterName, _params: GLint);
...
pub type PFN_glTexCoord1d = unsafe extern "system" fn(_s: CoordD);
...
pub type PFN_glVertexAttrib4ubvNV = unsafe extern "system" fn(_index: GLuint, _v: ColorUB);
pub type PFN_glFlushMappedBufferRangeAPPLE =
    unsafe extern "system" fn(_target: BufferTargetARB, _offset: BufferOffset, _size: BufferSize);
...
pub type PFN_glEvalCoord1fv = unsafe extern "system" fn(_u: CoordF);
pub type PFN_glVertexAttribI1iv = unsafe extern "system" fn(_index: GLuint, _v: GLint);
pub type PFN_glDeleteFencesNV = unsafe extern "system" fn(_n: GLsizei, _fences: FenceNV);
pub type PFN_glMinSampleShadingARB = unsafe extern "system" fn(_value: ColorF);
...
pub type PFN_glBinormal3fEXT = unsafe extern "system" fn(_bx: CoordF, _by: CoordF, _bz: CoordF);
...
pub type PFN_glVertexAttrib4ubNV =
    unsafe extern "system" fn(_index: GLuint, _x: ColorUB, _y: ColorUB, _z: ColorUB, _w: ColorUB);
...
pub type PFN_glFrameZoomSGIX = unsafe extern "system" fn(_factor: CheckedInt32);
pub type PFN_glMatrixLoadTransposefEXT = unsafe extern "system" fn(_mode: MatrixMode, _m: GLfloat);
pub type PFN_glGetSamplerParameterIivEXT =
    unsafe extern "system" fn(_sampler: GLuint, _pname: SamplerParameterI, _params: GLint);
pub type PFN_glBindLightParameterEXT =
    unsafe extern "system" fn(_light: LightName, _value: LightParameter);
...
pub type PFN_glIsPathNV = unsafe extern "system" fn(_path: Path);
pub type PFN_glGetAttribLocationARB =
    unsafe extern "system" fn(_programObj: handleARB, _name: GLcharARB);
...
pub type PFN_glGetQueryObjectuiv =
    unsafe extern "system" fn(_id: GLuint, _pname: QueryObjectParameterName, _params: GLuint);
pub type PFN_glColor3f = unsafe extern "system" fn(_red: ColorF, _green: ColorF, _blue: ColorF);
...
pub type PFN_glTexCoord4d =
    unsafe extern "system" fn(_s: CoordD, _t: CoordD, _r: CoordD, _q: CoordD);
...
pub type PFN_glCreateShaderProgramEXT =
    unsafe extern "system" fn(_type: ShaderType, _string: GLchar);
...
pub type PFN_glMultiTexCoord4f =
    unsafe extern "system" fn(_target: TextureUnit, _s: CoordF, _t: CoordF, _r: CoordF, _q: CoordF);
...
pub type PFN_glDebugMessageCallback =
    unsafe extern "system" fn(_callback: GLDEBUGPROC, _userParam: GLvoid);
pub type PFN_glIndexdv = unsafe extern "system" fn(_c: ColorIndexValueD);
...
pub type PFN_glWindowPos2dMESA = unsafe extern "system" fn(_x: CoordD, _y: CoordD);
...
pub type PFN_glGetMapxvOES =
    unsafe extern "system" fn(_target: MapTarget, _query: GetMapQuery, _v: GLfixed);
...
pub type PFN_glGetProgramiv =
    unsafe extern "system" fn(_program: GLuint, _pname: ProgramPropertyARB, _params: GLint);
pub type PFN_glNormalP3uiv = unsafe extern "system" fn(_type: NormalPointerType, _coords: GLuint);
...
pub type PFN_glCreateTextures =
    unsafe extern "system" fn(_target: TextureTarget, _n: GLsizei, _textures: GLuint);
...
pub type PFN_glCompileShaderARB = unsafe extern "system" fn(_shaderObj: handleARB);
...
pub type PFN_glEdgeFlagPointer = unsafe extern "system" fn(_stride: GLsizei, _pointer: GLvoid);
pub type PFN_glGetSamplerParameteriv =
    unsafe extern "system" fn(_sampler: GLuint, _pname: SamplerParameterI, _params: GLint);
pub type PFN_glMapObjectBufferATI = unsafe extern "system" fn(_buffer: GLuint);
pub type PFN_glSampleCoverage = unsafe extern "system" fn(_value: GLfloat, _invert: Boolean);
pub type PFN_glVertex3sv = unsafe extern "system" fn(_v: CoordS);
...
pub type PFN_glWindowPos2sARB = unsafe extern "system" fn(_x: CoordS, _y: CoordS);
...
pub type PFN_glWindowPos4ivMESA = unsafe extern "system" fn(_v: CoordI);
...
pub type PFN_glVertex2iv = unsafe extern "system" fn(_v: CoordI);
...
pub type PFN_glImportSemaphoreWin32NameEXT =
    unsafe extern "system" fn(_semaphore: GLuint, _handleType: ExternalHandleType, _name: GLvoid);
...
pub type PFN_glVertex4f = unsafe extern "system" fn(_x: CoordF, _y: CoordF, _z: CoordF, _w: CoordF);
...
pub type PFN_glTexCoord4dv = unsafe extern "system" fn(_v: CoordD);
pub type PFN_glShaderSource =
    unsafe extern "system" fn(_shader: GLuint, _count: GLsizei, _string: GLchar, _length: GLint);
pub type PFN_glRasterPos4iv = unsafe extern "system" fn(_v: CoordI);
...
pub type PFN_glFragmentLightModelfSGIX =
    unsafe extern "system" fn(_pname: FragmentLightModelParameterSGIX, _param: CheckedFloat32);
...
pub type PFN_glGetnPixelMapusvARB =
    unsafe extern "system" fn(_map: PixelMap, _bufSize: GLsizei, _values: GLushort);
pub type PFN_glDeleteRenderbuffersEXT =
    unsafe extern "system" fn(_n: GLsizei, _renderbuffers: GLuint);
pub type PFN_glTangentPointerEXT =
    unsafe extern "system" fn(_type: TangentPointerTypeEXT, _stride: GLsizei, _pointer: GLvoid);
...
pub type PFN_glTextureParameterIuiv =
    unsafe extern "system" fn(_texture: GLuint, _pname: TextureParameterName, _params: GLuint);
...
pub type PFN_glSetFenceAPPLE = unsafe extern "system" fn(_fence: FenceNV);
pub type PFN_glVertexAttrib4ivARB = unsafe extern "system" fn(_index: GLuint, _v: GLint);
pub type PFN_glVertexAttrib4hvNV = unsafe extern "system" fn(_index: GLuint, _v: Half16NV);
...
pub type PFN_glVertexP2uiv = unsafe extern "system" fn(_type: VertexPointerType, _value: GLuint);
pub type PFN_glRasterPos4fv = unsafe extern "system" fn(_v: CoordF);
...
pub type PFN_glClearColorxOES = unsafe extern "system" fn(
    _red: ClampedFixed,
    _green: ClampedFixed,
    _blue: ClampedFixed,
    _alpha: ClampedFixed,
...
pub type PFN_glColor4s =
    unsafe extern "system" fn(_red: ColorS, _green: ColorS, _blue: ColorS, _alpha: ColorS);
...
pub type PFN_glCallList = unsafe extern "system" fn(_list: List);
pub type PFN_glGetNamedFramebufferParameteriv =
    unsafe extern "system" fn(_framebuffer: GLuint, _pname: GetFramebufferParameter, _param: GLint);
pub type PFN_glGetFogFuncSGIS = unsafe extern "system" fn(_points: GLfloat);
pub type PFN_glIsEnablediOES = unsafe extern "system" fn(_target: EnableCap, _index: GLuint);
...
pub type PFN_glVertexP3uiv = unsafe extern "system" fn(_type: VertexPointerType, _value: GLuint);
pub type PFN_glWindowPos2fvARB = unsafe extern "system" fn(_v: CoordF);
pub type PFN_glGetPathCoordsNV = unsafe extern "system" fn(_path: Path, _coords: GLfloat);
...
pub type PFN_glVertexWeighthNV = unsafe extern "system" fn(_weight: Half16NV);
...
pub type PFN_glWindowPos2dARB = unsafe extern "system" fn(_x: CoordD, _y: CoordD);
...
pub type PFN_glMultiTexCoord1dARB = unsafe extern "system" fn(_target: TextureUnit, _s: CoordD);
pub type PFN_glRasterPos3i = unsafe extern "system" fn(_x: CoordI, _y: CoordI, _z: CoordI);
pub type PFN_glSelectBuffer = unsafe extern "system" fn(_size: GLsizei, _buffer: SelectName);
...
pub type PFN_glGetFragmentMaterialfvSGIX =
    unsafe extern "system" fn(_face: MaterialFace, _pname: MaterialParameter, _params: GLfloat);
pub type PFN_glWindowPos3iARB = unsafe extern "system" fn(_x: CoordI, _y: CoordI, _z: CoordI);
pub type PFN_glTexCoord2iv = unsafe extern "system" fn(_v: CoordI);
pub type PFN_glTexCoord2dv = unsafe extern "system" fn(_v: CoordD);
...
pub type PFN_glSecondaryColor3sEXT =
    unsafe extern "system" fn(_red: ColorS, _green: ColorS, _blue: ColorS);
pub type PFN_glMultiTexCoord2dvARB = unsafe extern "system" fn(_target: TextureUnit, _v: CoordD);
...
pub type PFN_glFogCoorddv = unsafe extern "system" fn(_coord: CoordD);
...
pub type PFN_glRasterPos3sv = unsafe extern "system" fn(_v: CoordS);
pub type PFN_glTexEstimateMotionRegionsQCOM =
    unsafe extern "system" fn(_ref: Texture, _target: Texture, _output: Texture, _mask: Texture);
pub type PFN_glGetVertexArrayiv =
    unsafe extern "system" fn(_vaobj: GLuint, _pname: VertexArrayPName, _param: GLint);
pub type PFN_glCreateCommandListsNV = unsafe extern "system" fn(_n: GLsizei, _lists: GLuint);
pub type PFN_glColor3us = unsafe extern "system" fn(_red: ColorUS, _green: ColorUS, _blue: ColorUS);
...
pub type PFN_glGetSamplerParameterfv =
    unsafe extern "system" fn(_sampler: GLuint, _pname: SamplerParameterF, _params: GLfloat);
...
pub type PFN_glMultiTexCoord4sv = unsafe extern "system" fn(_target: TextureUnit, _v: CoordS);
...
pub type PFN_glInvalidateBufferSubData =
    unsafe extern "system" fn(_buffer: GLuint, _offset: BufferOffset, _length: BufferSize);
...
pub type PFN_glSecondaryColor3b =
    unsafe extern "system" fn(_red: ColorB, _green: ColorB, _blue: ColorB);
pub type PFN_glMultiTexCoord2i =
    unsafe extern "system" fn(_target: TextureUnit, _s: CoordI, _t: CoordI);
pub type PFN_glCheckNamedFramebufferStatus =
    unsafe extern "system" fn(_framebuffer: GLuint, _target: FramebufferTarget);
...
pub type PFN_glMatrixLoadTransposedEXT = unsafe extern "system" fn(_mode: MatrixMode, _m: GLdouble);
...
pub type PFN_glSpriteParameterfSGIX =
    unsafe extern "system" fn(_pname: SpriteParameterNameSGIX, _param: CheckedFloat32);
...
pub type PFN_glPixelTexGenParameterivSGIS =
    unsafe extern "system" fn(_pname: PixelTexGenParameterNameSGIS, _params: CheckedInt32);
...
pub type PFN_glGetVariantArrayObjectivATI =
    unsafe extern "system" fn(_id: GLuint, _pname: ArrayObjectPNameATI, _params: GLint);
...
pub type PFN_glMultiTexCoord1ivARB = unsafe extern "system" fn(_target: TextureUnit, _v: CoordI);
...
pub type PFN_glListParameterfSGIX =
    unsafe extern "system" fn(_list: List, _pname: ListParameterName, _param: CheckedFloat32);
...
pub type PFN_glVertexStream4dvATI =
    unsafe extern "system" fn(_stream: VertexStreamATI, _coords: GLdouble);
pub type PFN_glPixelTexGenParameterfSGIS =
    unsafe extern "system" fn(_pname: PixelTexGenParameterNameSGIS, _param: CheckedFloat32);
pub type PFN_glCombinerParameteriNV =
    unsafe extern "system" fn(_pname: CombinerParameterNV, _param: GLint);
pub type PFN_glIsEnablediEXT = unsafe extern "system" fn(_target: EnableCap, _index: GLuint);
pub type PFN_glWindowPos4fMESA =
    unsafe extern "system" fn(_x: CoordF, _y: CoordF, _z: CoordF, _w: CoordF);
...
pub type PFN_glFinishFenceNV = unsafe extern "system" fn(_fence: FenceNV);
pub type PFN_glFogCoordd = unsafe extern "system" fn(_coord: CoordD);
...
pub type PFN_glFramebufferReadBufferEXT =
    unsafe extern "system" fn(_framebuffer: Framebuffer, _mode: ReadBufferMode);
pub type PFN_glMatrixLoadfEXT = unsafe extern "system" fn(_mode: MatrixMode, _m: GLfloat);
pub type PFN_glNewObjectBufferATI =
    unsafe extern "system" fn(_size: GLsizei, _pointer: GLvoid, _usage: ArrayObjectUsageATI);
...
pub type PFN_glIndexubv = unsafe extern "system" fn(_c: ColorIndexValueUB);
...
pub type PFN_glColor3ubv = unsafe extern "system" fn(_v: ColorUB);
pub type PFN_glCopyBufferSubDataNV = unsafe extern "system" fn(
    ...
    _readOffset: BufferOffset,
    _writeOffset: BufferOffset,
    _size: BufferSize,
);
pub type PFN_glCreateShaderObjectARB = unsafe extern "system" fn(_shaderType: ShaderType);
pub type PFN_glDrawTransformFeedbackInstancedEXT =
    unsafe extern "system" fn(_mode: PrimitiveType, _id: GLuint, _instancecount: GLsizei);
pub type PFN_glLineWidth = unsafe extern "system" fn(_width: CheckedFloat32);
pub type PFN_glTexCoord1i = unsafe extern "system" fn(_s: CoordI);
...
pub type PFN_glGetVariantArrayObjectfvATI =
    unsafe extern "system" fn(_id: GLuint, _pname: ArrayObjectPNameATI, _params: GLfloat);
...
pub type PFN_glIsEnablediNV = unsafe extern "system" fn(_target: EnableCap, _index: GLuint);
...
pub type PFN_glMultiTexCoord4fv = unsafe extern "system" fn(_target: TextureUnit, _v: CoordF);
...
pub type PFN_glFramebufferDrawBufferEXT =
    unsafe extern "system" fn(_framebuffer: Framebuffer, _mode: DrawBufferMode);
...
pub type PFN_glClipPlanef = unsafe extern "system" fn(_p: ClipPlaneName, _eqn: GLfloat);
...
pub type PFN_glGetClipPlanex = unsafe extern "system" fn(_plane: ClipPlaneName, _equation: GLfixed);
...
pub type PFN_glGetInteger64vAPPLE = unsafe extern "system" fn(_pname: GetPName, _params: GLint64);
...
pub type PFN_glWindowPos3sMESA = unsafe extern "system" fn(_x: CoordS, _y: CoordS, _z: CoordS);
...
pub type PFN_glCallLists =
    unsafe extern "system" fn(_n: GLsizei, _type: ListNameType, _lists: GLvoid);
...
pub type PFN_glCreateQueries =
    unsafe extern "system" fn(_target: QueryTarget, _n: GLsizei, _ids: GLuint);
pub type PFN_glBindMaterialParameterEXT =
    unsafe extern "system" fn(_face: MaterialFace, _value: MaterialParameter);
pub type PFN_glMakeBufferResidentNV = unsafe extern "system" fn(_target: GLenum, _access: GLenum);
pub type PFN_glClientWaitSync =
    unsafe extern "system" fn(_sync: sync, _flags: SyncObjectMask, _timeout: GLuint64);
...
pub type PFN_glLighti =
    unsafe extern "system" fn(_light: LightName, _pname: LightParameter, _param: CheckedInt32);
pub type PFN_glVertex3s = unsafe extern "system" fn(_x: CoordS, _y: CoordS, _z: CoordS);
...
pub type PFN_glVertex4hNV =
    unsafe extern "system" fn(_x: Half16NV, _y: Half16NV, _z: Half16NV, _w: Half16NV);
...
pub type PFN_glMultiTexCoord2hvNV = unsafe extern "system" fn(_target: TextureUnit, _v: Half16NV);
...
pub type PFN_glDepthRangexOES = unsafe extern "system" fn(_n: ClampedFixed, _f: ClampedFixed);
pub type PFN_glGetPathCommandsNV = unsafe extern "system" fn(_path: Path, _commands: PathCommand);
...
pub type PFN_glFogCoordhNV = unsafe extern "system" fn(_fog: Half16NV);
...
pub type PFN_glMultiTexCoord1hNV = unsafe extern "system" fn(_target: TextureUnit, _s: Half16NV);
pub type PFN_glMultiTexCoord2fvARB = unsafe extern "system" fn(_target: TextureUnit, _v: CoordF);
...
pub type PFN_glTexCoordP3ui =
    unsafe extern "system" fn(_type: TexCoordPointerType, _coords: GLuint);
pub type PFN_glVertexP4uiv = unsafe extern "system" fn(_type: VertexPointerType, _value: GLuint);
...
pub type PFN_glGetMaterialxv =
    unsafe extern "system" fn(_face: MaterialFace, _pname: MaterialParameter, _params: GLfixed);
...
pub type PFN_glDetachObjectARB =
    unsafe extern "system" fn(_containerObj: handleARB, _attachedObj: handleARB);
...
pub type PFN_glEvalCoord1f = unsafe extern "system" fn(_u: CoordF);
...
pub type PFN_glClearAccumxOES = unsafe extern "system" fn(
    _red: ClampedFixed,
    _green: ClampedFixed,
    _blue: ClampedFixed,
    _alpha: ClampedFixed,
...
pub type PFN_glColor4ui =
    unsafe extern "system" fn(_red: ColorUI, _green: ColorUI, _blue: ColorUI, _alpha: ColorUI);
...
pub type PFN_glGetLightfv =
    unsafe extern "system" fn(_light: LightName, _pname: LightParameter, _params: GLfloat);
...
pub type PFN_glGetProgramPipelineivEXT =
    unsafe extern "system" fn(_pipeline: GLuint, _pname: PipelineParameterName, _params: GLint);
...
pub type PFN_glGetnPixelMapuivARB =
    unsafe extern "system" fn(_map: PixelMap, _bufSize: GLsizei, _values: GLuint);
...
pub type PFN_glGetVertexAttribLdvEXT =
    unsafe extern "system" fn(_index: GLuint, _pname: VertexAttribEnum, _params: GLdouble);
...
pub type PFN_glBinormalPointerEXT =
    unsafe extern "system" fn(_type: BinormalPointerTypeEXT, _stride: GLsizei, _pointer: GLvoid);
...
pub type PFN_glVertexWeighthvNV = unsafe extern "system" fn(_weight: Half16NV);
pub type PFN_glBindTextureUnitParameterEXT =
    unsafe extern "system" fn(_unit: TextureUnit, _value: VertexShaderTextureUnitParameter);
...
pub type PFN_glPixelMapuiv =
    unsafe extern "system" fn(_map: PixelMap, _mapsize: CheckedInt32, _values: GLuint);
pub type PFN_glReplacementCodeuiTexCoord2fNormal3fVertex3fvSUN =
    unsafe extern "system" fn(_rc: ReplacementCodeSUN, _tc: GLfloat, _n: GLfloat, _v: GLfloat);
...
pub type PFN_glTexParameterIiv =
    unsafe extern "system" fn(_target: TextureTarget, _pname: TextureParameterName, _params: GLint);
pub type PFN_glEvalMesh2 = unsafe extern "system" fn(
    _mode: MeshMode2,
    _i1: CheckedInt32,
    _i2: CheckedInt32,
    _j1: CheckedInt32,
...
pub type PFN_glTexGeni = unsafe extern "system" fn(
    _coord: TextureCoordName,
    _pname: TextureGenParameter,
    _param: CheckedInt32,
);
...
pub type PFN_glVertexAttrib2hvNV = unsafe extern "system" fn(_index: GLuint, _v: Half16NV);
...
pub type PFN_glProgramUniform3ivEXT =
    unsafe extern "system" fn(_program: GLuint, _location: GLint, _count: GLsizei, _value: GLint);
pub type PFN_glVertexAttrib3hvNV = unsafe extern "system" fn(_index: GLuint, _v: Half16NV);
pub type PFN_glWaitSync =
    unsafe extern "system" fn(_sync: sync, _flags: SyncBehaviorFlags, _timeout: GLuint64);
...
pub type PFN_glMultiTexCoord1fARB = unsafe extern "system" fn(_target: TextureUnit, _s: CoordF);
...
pub type PFN_glWindowPos3fvMESA = unsafe extern "system" fn(_v: CoordF);
...
pub type PFN_glWindowPos2ivARB = unsafe extern "system" fn(_v: CoordI);
...
pub type PFN_glVertexAttrib1hvNV = unsafe extern "system" fn(_index: GLuint, _v: Half16NV);
...
pub type PFN_glTexCoord3s = unsafe extern "system" fn(_s: CoordS, _t: CoordS, _r: CoordS);
...
pub type PFN_glColor3ui = unsafe extern "system" fn(_red: ColorUI, _green: ColorUI, _blue: ColorUI);
...
pub type PFN_glRasterPos3dv = unsafe extern "system" fn(_v: CoordD);
...
pub type PFN_glRenderMode = unsafe extern "system" fn(_mode: RenderingMode);
...
pub type PFN_glMapNamedBuffer =
    unsafe extern "system" fn(_buffer: GLuint, _access: BufferAccessARB);
...
pub type PFN_glGetArrayObjectivATI =
    unsafe extern "system" fn(_array: EnableCap, _pname: ArrayObjectPNameATI, _params: GLint);
...
pub type PFN_glIsEnabledi = unsafe extern "system" fn(_target: EnableCap, _index: GLuint);
...
pub type PFN_glEdgeFlagv = unsafe extern "system" fn(_flag: Boolean);
...
pub type PFN_glTexCoord1sv = unsafe extern "system" fn(_v: CoordS);
pub type PFN_glGetOcclusionQueryivNV =
    unsafe extern "system" fn(_id: GLuint, _pname: OcclusionQueryParameterNameNV, _params: GLint);
...
pub type PFN_glVDPAUMapSurfacesNV =
    unsafe extern "system" fn(_numSurfaces: GLsizei, _surfaces: vdpauSurfaceNV);
...
pub type PFN_glObjectPtrLabel =
    unsafe extern "system" fn(_ptr: GLvoid, _length: GLsizei, _label: GLchar);
...
pub type PFN_glDeletePathsNV = unsafe extern "system" fn(_path: Path, _range: GLsizei);
...
pub type PFN_glDeleteObjectARB = unsafe extern "system" fn(_obj: handleARB);
pub type PFN_glVertexAttrib2hNV =
    unsafe extern "system" fn(_index: GLuint, _x: Half16NV, _y: Half16NV);
...
pub type PFN_glMapNamedBufferEXT =
    unsafe extern "system" fn(_buffer: GLuint, _access: BufferAccessARB);
pub type PFN_glGetVertexAttribArrayObjectivATI =
    unsafe extern "system" fn(_index: GLuint, _pname: ArrayObjectPNameATI, _params: GLint);
...
pub type PFN_glPrioritizeTexturesxOES =
    unsafe extern "system" fn(_n: GLsizei, _textures: GLuint, _priorities: ClampedFixed);
...
pub type PFN_glWindowPos3iMESA = unsafe extern "system" fn(_x: CoordI, _y: CoordI, _z: CoordI);
...
pub type PFN_glFogiv = unsafe extern "system" fn(_pname: FogParameter, _params: CheckedInt32);
...
pub type PFN_glColor4uiv = unsafe extern "system" fn(_v: ColorUI);
...
pub type PFN_glColor4hvNV = unsafe extern "system" fn(_v: Half16NV);
...
pub type PFN_glRects =
    unsafe extern "system" fn(_x1: CoordS, _y1: CoordS, _x2: CoordS, _y2: CoordS);
pub type PFN_glScaled = unsafe extern "system" fn(_x: GLdouble, _y: GLdouble, _z: GLdouble);
pub type PFN_glTexCoord2s = unsafe extern "system" fn(_s: CoordS, _t: CoordS);
pub type PFN_glGetUnsignedBytei_vEXT =
    unsafe extern "system" fn(_target: GLenum, _index: GLuint, _data: GLubyte);
pub type PFN_glVDPAUIsSurfaceNV = unsafe extern "system" fn(_surface: vdpauSurfaceNV);
...
pub type PFN_glEvalMesh1 =
    unsafe extern "system" fn(_mode: MeshMode1, _i1: CheckedInt32, _i2: CheckedInt32);
...
pub type PFN_glInterpolatePathsNV =
    unsafe extern "system" fn(_resultPath: Path, _pathA: Path, _pathB: Path, _weight: GLfloat);
pub type PFN_glGenVertexArrays = unsafe extern "system" fn(_n: GLsizei, _arrays: GLuint);
pub type PFN_glBinormal3fvEXT = unsafe extern "system" fn(_v: CoordF);
...
pub type PFN_glDepthMask = unsafe extern "system" fn(_flag: Boolean);
...
pub type PFN_glColor3d = unsafe extern "system" fn(_red: ColorD, _green: ColorD, _blue: ColorD);
...
pub type PFN_glVertexAttrib3sNV =
    unsafe extern "system" fn(_index: GLuint, _x: GLshort, _y: GLshort, _z: GLshort);
pub type PFN_glFogi = unsafe extern "system" fn(_pname: FogParameter, _param: CheckedInt32);
...
pub type PFN_glTexCoord3fv = unsafe extern "system" fn(_v: CoordF);
...
pub type PFN_glBindFramebuffer =
    unsafe extern "system" fn(_target: FramebufferTarget, _framebuffer: GLuint);
pub type PFN_glColorP3uiv = unsafe extern "system" fn(_type: ColorPointerType, _color: GLuint);
...
pub type PFN_glGetSubroutineIndex =
    unsafe extern "system" fn(_program: GLuint, _shadertype: ShaderType, _name: GLchar);
...
pub type PFN_glTextureParameterIiv =
    unsafe extern "system" fn(_texture: GLuint, _pname: TextureParameterName, _params: GLint);
pub type PFN_glSecondaryColor3ubv = unsafe extern "system" fn(_v: ColorUB);
pub type PFN_glBlendEquation = unsafe extern "system" fn(_mode: BlendEquationModeEXT);
pub type PFN_glVDPAUInitNV = unsafe extern "system" fn(_vdpDevice: GLvoid, _getProcAddress: GLvoid);
...
pub type PFN_glGetQueryObjectui64v =
    unsafe extern "system" fn(_id: GLuint, _pname: QueryObjectParameterName, _params: GLuint64);
...
pub type PFN_glGetNamedBufferSubDataEXT =
    unsafe extern "system" fn(_buffer: GLuint, _offset: GLintptr, _size: GLsizeiptr, _data: GLvoid);
...
pub type PFN_glBindRenderbufferEXT =
    unsafe extern "system" fn(_target: RenderbufferTarget, _renderbuffer: GLuint);
pub type PFN_glMultiTexCoord1d = unsafe extern "system" fn(_target: TextureUnit, _s: CoordD);
...
pub type PFN_glDeleteFencesAPPLE = unsafe extern "system" fn(_n: GLsizei, _fences: FenceNV);
...
pub type PFN_glTexCoord3hvNV = unsafe extern "system" fn(_v: Half16NV);
...
pub type PFN_glGetClipPlanefOES =
    unsafe extern "system" fn(_plane: ClipPlaneName, _equation: GLfloat);
...
pub type PFN_glNormalPointervINTEL =
    unsafe extern "system" fn(_type: NormalPointerType, _pointer: GLvoid);
pub type PFN_glBindShadingRateImageNV = unsafe extern "system" fn(_texture: GLuint);
pub type PFN_glFragmentLightModeliSGIX =
    unsafe extern "system" fn(_pname: FragmentLightModelParameterSGIX, _param: CheckedInt32);
pub type PFN_glIndexs = unsafe extern "system" fn(_c: ColorIndexValueS);
...
pub type PFN_glGetVertexAttribfv =
    unsafe extern "system" fn(_index: GLuint, _pname: VertexAttribPropertyARB, _params: GLfloat);
pub type PFN_glWindowPos3ivARB = unsafe extern "system" fn(_v: CoordI);
pub type PFN_glMultiTexCoord1fv = unsafe extern "system" fn(_target: TextureUnit, _v: CoordF);
pub type PFN_glGetUniformi64vNV =
    unsafe extern "system" fn(_program: GLuint, _location: GLint, _params: GLint64EXT);
pub type PFN_glIsTextureEXT = unsafe extern "system" fn(_texture: Texture);
...
pub type PFN_glMatrixMultfEXT = unsafe extern "system" fn(_mode: MatrixMode, _m: GLfloat);
...
pub type PFN_glClearColor =
    unsafe extern "system" fn(_red: ColorF, _green: ColorF, _blue: ColorF, _alpha: ColorF);
pub type PFN_glMultiTexCoord1sARB = unsafe extern "system" fn(_target: TextureUnit, _s: CoordS);
pub type PFN_glGetVertexAttribdvNV =
    unsafe extern "system" fn(_index: GLuint, _pname: VertexAttribEnumNV, _params: GLdouble);
...
pub type PFN_glLightfv =
    unsafe extern "system" fn(_light: LightName, _pname: LightParameter, _params: CheckedFloat32);
pub type PFN_glDepthFunc = unsafe extern "system" fn(_func: DepthFunction);
pub type PFN_glGetVertexAttribLi64vNV =
    unsafe extern "system" fn(_index: GLuint, _pname: VertexAttribEnum, _params: GLint64EXT);
...
pub type PFN_glPixelTransferf =
    unsafe extern "system" fn(_pname: PixelTransferParameter, _param: CheckedFloat32);
...
pub type PFN_glGetLightiv =
    unsafe extern "system" fn(_light: LightName, _pname: LightParameter, _params: GLint);
pub type PFN_glGetIntegeri_vEXT =
    unsafe extern "system" fn(_target: GetPName, _index: GLuint, _data: GLint);
pub type PFN_glGetVertexAttribivARB =
    unsafe extern "system" fn(_index: GLuint, _pname: VertexAttribPropertyARB, _params: GLint);
...
pub type PFN_glSpriteParameterivSGIX =
    unsafe extern "system" fn(_pname: SpriteParameterNameSGIX, _params: CheckedInt32);
pub type PFN_glTexCoord3hNV = unsafe extern "system" fn(_s: Half16NV, _t: Half16NV, _r: Half16NV);
...
pub type PFN_glIndexFuncEXT =
    unsafe extern "system" fn(_func: IndexFunctionEXT, _ref: ClampedFloat32);
...
pub type PFN_glIndexf = unsafe extern "system" fn(_c: ColorIndexValueF);
...
pub type PFN_glWindowPos3fvARB = unsafe extern "system" fn(_v: CoordF);
...
pub type PFN_glSignalSemaphoreEXT = unsafe extern "system" fn(
    ...
    _numTextureBarriers: GLuint,
    _textures: GLuint,
    _dstLayouts: TextureLayout,
);
pub type PFN_glVertexStream4fvATI =
    unsafe extern "system" fn(_stream: VertexStreamATI, _coords: GLfloat);
pub type PFN_glGetNamedBufferParameterui64vNV =
    unsafe extern "system" fn(_buffer: GLuint, _pname: BufferPNameARB, _params: GLuint64EXT);
...
pub type PFN_glWindowPos2iv = unsafe extern "system" fn(_v: CoordI);
pub type PFN_glStencilMask = unsafe extern "system" fn(_mask: MaskedStencilValue);
...
pub type PFN_glUniform4iv =
    unsafe extern "system" fn(_location: GLint, _count: GLsizei, _value: GLint);
pub type PFN_glWindowPos3i = unsafe extern "system" fn(_x: CoordI, _y: CoordI, _z: CoordI);
pub type PFN_glWindowPos4iMESA =
    unsafe extern "system" fn(_x: CoordI, _y: CoordI, _z: CoordI, _w: CoordI);
...
pub type PFN_glWindowPos3dMESA = unsafe extern "system" fn(_x: CoordD, _y: CoordD, _z: CoordD);
...
pub type PFN_glRasterPos2f = unsafe extern "system" fn(_x: CoordF, _y: CoordF);
...
pub type PFN_glGetInteger64i_v =
    unsafe extern "system" fn(_target: GetPName, _index: GLuint, _data: GLint64);
...
pub type PFN_glWindowPos2sv = unsafe extern "system" fn(_v: CoordS);
pub type PFN_glGetBufferParameteri64v =
    unsafe extern "system" fn(_target: BufferTargetARB, _pname: BufferPNameARB, _params: GLint64);
pub type PFN_glVertexArrayAttribBinding =
    unsafe extern "system" fn(_vaobj: GLuint, _attribindex: GLuint, _bindingindex: GLuint);
pub type PFN_glClipPlanefOES = unsafe extern "system" fn(_plane: ClipPlaneName, _equation: GLfloat);
...
pub type PFN_glLoadName = unsafe extern "system" fn(_name: SelectName);
...
pub type PFN_glVertexAttrib4sARB =
    unsafe extern "system" fn(_index: GLuint, _x: GLshort, _y: GLshort, _z: GLshort, _w: GLshort);
pub type PFN_glWindowPos2fvMESA = unsafe extern "system" fn(_v: CoordF);
pub type PFN_glFlushMappedNamedBufferRange =
    unsafe extern "system" fn(_buffer: GLuint, _offset: GLintptr, _length: BufferSize);
...
pub type PFN_glColorMaskIndexedEXT =
    unsafe extern "system" fn(_index: GLuint, _r: Boolean, _g: Boolean, _b: Boolean, _a: Boolean);
...
pub type PFN_glCheckFramebufferStatusEXT = unsafe extern "system" fn(_target: FramebufferTarget);
pub type PFN_glClipPlanexOES = unsafe extern "system" fn(_plane: ClipPlaneName, _equation: GLfixed);
...
pub type PFN_glWindowPos4dvMESA = unsafe extern "system" fn(_v: CoordD);
...
pub type PFN_glReplacementCodePointerSUN =
    unsafe extern "system" fn(_type: ReplacementCodeTypeSUN, _stride: GLsizei, _pointer: GLvoid);
pub type PFN_glLoadMatrixx = unsafe extern "system" fn(_m: GLfixed);
pub type PFN_glEvalCoord2f = unsafe extern "system" fn(_u: CoordF, _v: CoordF);
pub type PFN_glProgramNamedParameter4fvNV =
    unsafe extern "system" fn(_id: GLuint, _len: GLsizei, _name: GLubyte, _v: GLfloat);
pub type PFN_glNamedBufferSubDataEXT =
    unsafe extern "system" fn(_buffer: GLuint, _offset: GLintptr, _size: BufferSize, _data: GLvoid);
pub type PFN_glSecondaryColor3ivEXT = unsafe extern "system" fn(_v: ColorI);
...
pub type PFN_glGetQueryObjecti64vEXT =
    unsafe extern "system" fn(_id: GLuint, _pname: QueryObjectParameterName, _params: GLint64);
pub type PFN_glMapGrid1d = unsafe extern "system" fn(_un: GLint, _u1: CoordD, _u2: CoordD);
...
pub type PFN_glIsList = unsafe extern "system" fn(_list: List);
...
pub type PFN_glTexCoordP1uiv =
    unsafe extern "system" fn(_type: TexCoordPointerType, _coords: GLuint);
pub type PFN_glTexCoord1s = unsafe extern "system" fn(_s: CoordS);
...
pub type PFN_glTextureRenderbufferEXT =
    unsafe extern "system" fn(_texture: Texture, _target: TextureTarget, _renderbuffer: GLuint);
pub type PFN_glMinSampleShadingOES = unsafe extern "system" fn(_value: ColorF);
pub type PFN_glGetMapiv =
    unsafe extern "system" fn(_target: MapTarget, _query: GetMapQuery, _v: GLint);
...
pub type PFN_glColor3hvNV = unsafe extern "system" fn(_v: Half16NV);
pub type PFN_glGetProgramivARB =
    unsafe extern "system" fn(_target: ProgramTarget, _pname: ProgramPropertyARB, _params: GLint);
...
pub type PFN_glDrawBuffers = unsafe extern "system" fn(_n: GLsizei, _bufs: DrawBufferMode);
...
pub type PFN_glRasterPos3fv = unsafe extern "system" fn(_v: CoordF);
...
pub type PFN_glWindowPos2dv = unsafe extern "system" fn(_v: CoordD);
...
pub type PFN_glRasterPos3f = unsafe extern "system" fn(_x: CoordF, _y: CoordF, _z: CoordF);
pub type PFN_glGetUniformuivEXT =
    unsafe extern "system" fn(_program: GLuint, _location: GLint, _params: GLuint);
pub type PFN_glGenFencesNV = unsafe extern "system" fn(_n: GLsizei, _fences: FenceNV);
...
pub type PFN_glMapParameterivNV =
    unsafe extern "system" fn(_target: EvalTargetNV, _pname: MapParameterNV, _params: CheckedInt32);
...
pub type PFN_glLineStipple =
    unsafe extern "system" fn(_factor: CheckedInt32, _pattern: LineStipple);
...
pub type PFN_glSpriteParameteriSGIX =
    unsafe extern "system" fn(_pname: SpriteParameterNameSGIX, _param: CheckedInt32);
pub type PFN_glVertex3bOES = unsafe extern "system" fn(_x: GLbyte, _y: GLbyte, _z: GLbyte);
pub type PFN_glVertex2hNV = unsafe extern "system" fn(_x: Half16NV, _y: Half16NV);
...
pub type PFN_glTexParameterx =
    unsafe extern "system" fn(_target: TextureTarget, _pname: GetTextureParameter, _param: GLfixed);
pub type PFN_glVertex4hvNV = unsafe extern "system" fn(_v: Half16NV);
...
pub type PFN_glGetStageIndexNV = unsafe extern "system" fn(_shadertype: ShaderType);
...
pub type PFN_glGetNamedBufferParameteri64v =
    unsafe extern "system" fn(_buffer: GLuint, _pname: BufferPNameARB, _params: GLint64);
...
pub type PFN_glGetProgramEnvParameterIivNV =
    unsafe extern "system" fn(_target: ProgramTarget, _index: GLuint, _params: GLint);
pub type PFN_glClipPlane = unsafe extern "system" fn(_plane: ClipPlaneName, _equation: GLdouble);
pub type PFN_glGetMapParameterivNV =
    unsafe extern "system" fn(_target: EvalTargetNV, _pname: MapParameterNV, _params: GLint);
...
pub type PFN_glTestFenceNV = unsafe extern "system" fn(_fence: FenceNV);
...
pub type PFN_glMatrixMultdEXT = unsafe extern "system" fn(_mode: MatrixMode, _m: GLdouble);
...
pub type PFN_glSpriteParameterfvSGIX =
    unsafe extern "system" fn(_pname: SpriteParameterNameSGIX, _params: CheckedFloat32);
...
pub type PFN_glReplacementCodeuiColor4fNormal3fVertex3fvSUN =
    unsafe extern "system" fn(_rc: ReplacementCodeSUN, _c: GLfloat, _n: GLfloat, _v: GLfloat);
...
pub type PFN_glColor3b = unsafe extern "system" fn(_red: ColorB, _green: ColorB, _blue: ColorB);
...
pub type PFN_glGetProgramivNV =
    unsafe extern "system" fn(_id: GLuint, _pname: VertexAttribEnumNV, _params: GLint);
...
pub type PFN_glVertex4s = unsafe extern "system" fn(_x: CoordS, _y: CoordS, _z: CoordS, _w: CoordS);
...
pub type PFN_glMultiTexCoord4s =
    unsafe extern "system" fn(_target: TextureUnit, _s: CoordS, _t: CoordS, _r: CoordS, _q: CoordS);
...
pub type PFN_glDebugMessageCallbackAMD =
    unsafe extern "system" fn(_callback: GLDEBUGPROCAMD, _userParam: GLvoid);
...
pub type PFN_glGetListParameterfvSGIX =
    unsafe extern "system" fn(_list: List, _pname: ListParameterName, _params: CheckedFloat32);
pub type PFN_glMultiTexCoord1svARB = unsafe extern "system" fn(_target: TextureUnit, _v: CoordS);
...
pub type PFN_glIsTexture = unsafe extern "system" fn(_texture: Texture);
...
pub type PFN_glGetProgramResourceiv = unsafe extern "system" fn(
    ...
    _index: GLuint,
    _propCount: GLsizei,
    _props: ProgramResourceProperty,
    _count: GLsizei,
    _length: GLsizei,
    _params: GLint,
);
...
pub type PFN_glRectd =
    unsafe extern "system" fn(_x1: CoordD, _y1: CoordD, _x2: CoordD, _y2: CoordD);
...
pub type PFN_glGetObjectBufferivATI =
    unsafe extern "system" fn(_buffer: GLuint, _pname: ArrayObjectPNameATI, _params: GLint);
...
pub type PFN_glPolygonOffsetClampEXT =
    unsafe extern "system" fn(_factor: GLfloat, _units: GLfloat, _clamp: GLfloat);
pub type PFN_glStringMarkerGREMEDY = unsafe extern "system" fn(_len: GLsizei, _string: GLvoid);
...
pub type PFN_glWindowPos4fvMESA = unsafe extern "system" fn(_v: CoordF);
...
pub type PFN_glMultiTexCoord3dv = unsafe extern "system" fn(_target: TextureUnit, _v: CoordD);
...
pub type PFN_glMultiTexCoord3ivARB = unsafe extern "system" fn(_target: TextureUnit, _v: CoordI);
...
pub type PFN_glTexCoord3i = unsafe extern "system" fn(_s: CoordI, _t: CoordI, _r: CoordI);
...
pub type PFN_glEdgeFlagPointerListIBM =
    unsafe extern "system" fn(_stride: GLint, _pointer: BooleanPointer, _ptrstride: GLint);
pub type PFN_glVertexAttrib1hNV = unsafe extern "system" fn(_index: GLuint, _x: Half16NV);
...
pub type PFN_glCheckFramebufferStatusOES = unsafe extern "system" fn(_target: FramebufferTarget);
...
pub type PFN_glRectdv = unsafe extern "system" fn(_v1: CoordD, _v2: CoordD);
...
pub type PFN_glWindowPos3dvMESA = unsafe extern "system" fn(_v: CoordD);
...
pub type PFN_glLightModeliv =
    unsafe extern "system" fn(_pname: LightModelParameter, _params: GLint);
...
pub type PFN_glClearBufferiv =
    unsafe extern "system" fn(_buffer: Buffer, _drawbuffer: DrawBufferName, _value: GLint);
pub type PFN_glPauseTransformFeedbackNV = unsafe extern "system" fn();
pub type PFN_glPixelMapfv =
    unsafe extern "system" fn(_map: PixelMap, _mapsize: CheckedInt32, _values: GLfloat);
pub type PFN_glRasterPos3iv = unsafe extern "system" fn(_v: CoordI);
...
pub type PFN_glMultiTexCoord3hNV =
    unsafe extern "system" fn(_target: TextureUnit, _s: Half16NV, _t: Half16NV, _r: Half16NV);
...
pub type PFN_glTextureRangeAPPLE =
    unsafe extern "system" fn(_target: GLenum, _length: GLsizei, _pointer: GLvoid);
pub type PFN_glWindowPos3sv = unsafe extern "system" fn(_v: CoordS);
...
pub type PFN_glReplacementCodeuiNormal3fVertex3fvSUN =
    unsafe extern "system" fn(_rc: ReplacementCodeSUN, _n: GLfloat, _v: GLfloat);
...
pub type PFN_glGetTransformFeedbackiv =
    unsafe extern "system" fn(_xfb: GLuint, _pname: TransformFeedbackPName, _param: GLint);
pub type PFN_glPNTrianglesiATI =
    unsafe extern "system" fn(_pname: PNTrianglesPNameATI, _param: GLint);
pub type PFN_glEvalCoord2dv = unsafe extern "system" fn(_u: CoordD);
pub type PFN_glWindowPos3sARB = unsafe extern "system" fn(_x: CoordS, _y: CoordS, _z: CoordS);
...
pub type PFN_glBindAttribLocationARB =
    unsafe extern "system" fn(_programObj: handleARB, _index: GLuint, _name: GLcharARB);
...
pub type PFN_glGetString = unsafe extern "system" fn(_name: StringName);
...
pub type PFN_glGetTexBumpParameterfvATI =
    unsafe extern "system" fn(_pname: GetTexBumpParameterATI, _param: GLfloat);
...
pub type PFN_glDeleteFramebuffersEXT =
    unsafe extern "system" fn(_n: GLsizei, _framebuffers: GLuint);
pub type PFN_glGetPointervKHR = unsafe extern "system" fn(_pname: GLenum, _params: GLvoid);
...
pub type PFN_glDrawArraysIndirect =
    unsafe extern "system" fn(_mode: PrimitiveType, _indirect: GLvoid);
...
pub type PFN_glMultiTexCoord3svARB = unsafe extern "system" fn(_target: TextureUnit, _v: CoordS);
...
pub type PFN_glGetStringi = unsafe extern "system" fn(_name: StringName, _index: GLuint);
pub type PFN_glBindFragDataLocation =
    unsafe extern "system" fn(_program: GLuint, _color: GLuint, _name: GLchar);
pub type PFN_glFramebufferDrawBuffersEXT =
    unsafe extern "system" fn(_framebuffer: Framebuffer, _n: GLsizei, _bufs: DrawBufferMode);
pub type PFN_glGetPixelMapuiv = unsafe extern "system" fn(_map: PixelMap, _values: GLuint);
...
pub type PFN_glSamplerParameterIiv =
    unsafe extern "system" fn(_sampler: GLuint, _pname: SamplerParameterI, _param: GLint);
pub type PFN_glVertex4dv = unsafe extern "system" fn(_v: CoordD);
...
pub type PFN_glWindowPos2s = unsafe extern "system" fn(_x: CoordS, _y: CoordS);
...
pub type PFN_glTexBumpParameterfvATI =
    unsafe extern "system" fn(_pname: TexBumpParameterATI, _param: GLfloat);
pub type PFN_glMulticastViewportArrayvNVX =
    unsafe extern "system" fn(_gpu: GLuint, _first: GLuint, _count: GLsizei, _v: GLfloat);
pub type PFN_glPointSize = unsafe extern "system" fn(_size: CheckedFloat32);
...
pub type PFN_glVertex3f = unsafe extern "system" fn(_x: CoordF, _y: CoordF, _z: CoordF);
...
pub type PFN_glColor3i = unsafe extern "system" fn(_red: ColorI, _green: ColorI, _blue: ColorI);
...
pub type PFN_glGetMapfv =
    unsafe extern "system" fn(_target: MapTarget, _query: GetMapQuery, _v: GLfloat);
pub type PFN_glMatrixMultTransposefEXT = unsafe extern "system" fn(_mode: MatrixMode, _m: GLfloat);
...
pub type PFN_glSecondaryColor3fv = unsafe extern "system" fn(_v: ColorF);
...
pub type PFN_glColor4iv = unsafe extern "system" fn(_v: ColorI);
...
pub type PFN_glReplacementCodeuiVertex3fSUN =
    unsafe extern "system" fn(_rc: ReplacementCodeSUN, _x: GLfloat, _y: GLfloat, _z: GLfloat);
...
pub type PFN_glClientWaitSyncAPPLE =
    unsafe extern "system" fn(_sync: sync, _flags: SyncObjectMask, _timeout: GLuint64);
pub type PFN_glIsEnabled = unsafe extern "system" fn(_cap: EnableCap);
pub type PFN_glMinSampleShading = unsafe extern "system" fn(_value: ColorF);
...
pub type PFN_glSecondaryColor3ubEXT =
    unsafe extern "system" fn(_red: ColorUB, _green: ColorUB, _blue: ColorUB);
pub type PFN_glWindowPos3svMESA = unsafe extern "system" fn(_v: CoordS);
...
pub type PFN_glGenerateTextureMipmapEXT =
    unsafe extern "system" fn(_texture: Texture, _target: TextureTarget);
...
pub type PFN_glIglooInterfaceSGIX = unsafe extern "system" fn(_pname: GLenum, _params: GLvoid);
...
pub type PFN_glRasterPos2dv = unsafe extern "system" fn(_v: CoordD);
pub type PFN_glPixelTexGenParameteriSGIS =
    unsafe extern "system" fn(_pname: PixelTexGenParameterNameSGIS, _param: CheckedInt32);
...
pub type PFN_glColor3usv = unsafe extern "system" fn(_v: ColorUS);
pub type PFN_glReplacementCodeuiTexCoord2fVertex3fvSUN =
    unsafe extern "system" fn(_rc: ReplacementCodeSUN, _tc: GLfloat, _v: GLfloat);
pub type PFN_glTexCoord2i = unsafe extern "system" fn(_s: CoordI, _t: CoordI);
...
pub type PFN_glRasterPos2s = unsafe extern "system" fn(_x: CoordS, _y: CoordS);
pub type PFN_glVertex2s = unsafe extern "system" fn(_x: CoordS, _y: CoordS);
...
pub type PFN_glTexCoord4hvNV = unsafe extern "system" fn(_v: Half16NV);
...
pub type PFN_glGetInteger64v = unsafe extern "system" fn(_pname: GetPName, _data: GLint64);
pub type PFN_glIsVariantEnabledEXT = unsafe extern "system" fn(_id: GLuint, _cap: VariantCapEXT);
...
pub type PFN_glSecondaryColor3d =
    unsafe extern "system" fn(_red: ColorD, _green: ColorD, _blue: ColorD);
pub type PFN_glMultiTexCoord1i = unsafe extern "system" fn(_target: TextureUnit, _s: CoordI);
...
pub type PFN_glRasterPos2i = unsafe extern "system" fn(_x: CoordI, _y: CoordI);
pub type PFN_glRasterPos4d =
    unsafe extern "system" fn(_x: CoordD, _y: CoordD, _z: CoordD, _w: CoordD);
pub type PFN_glGenFencesAPPLE = unsafe extern "system" fn(_n: GLsizei, _fences: FenceNV);
...
pub type PFN_glGetObjectParameterfvARB =
    unsafe extern "system" fn(_obj: handleARB, _pname: GLenum, _params: GLfloat);
pub type PFN_glTexCoord3iv = unsafe extern "system" fn(_v: CoordI);
...
pub type PFN_glVertexAttribL3dEXT =
    unsafe extern "system" fn(_index: GLuint, _x: GLdouble, _y: GLdouble, _z: GLdouble);
pub type PFN_glWindowPos3s = unsafe extern "system" fn(_x: CoordS, _y: CoordS, _z: CoordS);
...
pub type PFN_glGetPathLengthNV =
    unsafe extern "system" fn(_path: Path, _startSegment: GLsizei, _numSegments: GLsizei);
