        ...
        F: FnMut(&::std::ffi::CStr) -> *const c_void,
    {
        Self {
            ...
            glUnmapBuffer: unsafe {
                unsafe extern "system" fn __glUnmapBuffer(_target: BufferTargetARB) {
            ...
            glIsQuery: unsafe {
                unsafe extern "system" fn __glIsQuery(_id: GLuint) {
            ...
            glIsBuffer: unsafe {
                unsafe extern "system" fn __glIsBuffer(_buffer: GLuint) {
        ...
        F: FnMut(&::std::ffi::CStr) -> *const c_void,
    {
        Self {
            ...
            glGetGraphicsResetStatus: unsafe {
                unsafe extern "system" fn __glGetGraphicsResetStatus() {
            ...
            glUnmapNamedBuffer: unsafe {
                unsafe extern "system" fn __glUnmapNamedBuffer(_buffer: GLuint) {
        ...
        F: FnMut(&::std::ffi::CStr) -> *const c_void,
    {
        Self {
            ...
            glCreateShader: unsafe {
                unsafe extern "system" fn __glCreateShader(_type: ShaderType) {
            ...
            glGetAttribLocation: unsafe {
                unsafe extern "system" fn __glGetAttribLocation(_program: GLuint, _name: GLchar) {
            ...
            glGetUniformLocation: unsafe {
                unsafe extern "system" fn __glGetUniformLocation(_program: GLuint, _name: GLchar) {
            ...
            glIsProgram: unsafe {
                unsafe extern "system" fn __glIsProgram(_program: GLuint) {
            ...
            glCreateProgram: unsafe {
                unsafe extern "system" fn __glCreateProgram() {
            ...
            glIsShader: unsafe {
                unsafe extern "system" fn __glIsShader(_shader: GLuint) {
...
impl EntryFnGL10 {
        ...
        F: FnMut(&::std::ffi::CStr) -> *const c_void,
    {
        Self {
            ...
            glGetError: unsafe {
                unsafe extern "system" fn __glGetError() {
            ...
            glGetString: unsafe {
                unsafe extern "system" fn __glGetString(_name: StringName) {
            ...
            glGenLists: unsafe {
                unsafe extern "system" fn __glGenLists(_range: GLsizei) {
            ...
            glIsList: unsafe {
                unsafe extern "system" fn __glIsList(_list: GLuint) {
            ...
            glRenderMode: unsafe {
                unsafe extern "system" fn __glRenderMode(_mode: RenderingMode) {
            ...
            glIsEnabled: unsafe {
                unsafe extern "system" fn __glIsEnabled(_cap: EnableCap) {
        ...
        F: FnMut(&::std::ffi::CStr) -> *const c_void,
    {
        Self {
            ...
            glIsTransformFeedback: unsafe {
                unsafe extern "system" fn __glIsTransformFeedback(_id: GLuint) {
        ...
        F: FnMut(&::std::ffi::CStr) -> *const c_void,
    {
        Self {
            ...
            glIsFramebuffer: unsafe {
                unsafe extern "system" fn __glIsFramebuffer(_framebuffer: GLuint) {
            ...
            glIsRenderbuffer: unsafe {
                unsafe extern "system" fn __glIsRenderbuffer(_renderbuffer: GLuint) {
            ...
            glGetStringi: unsafe {
                unsafe extern "system" fn __glGetStringi(_name: StringName, _index: GLuint) {
            ...
            glIsEnabledi: unsafe {
                unsafe extern "system" fn __glIsEnabledi(_target: EnableCap, _index: GLuint) {
            ...
            glCheckFramebufferStatus: unsafe {
                unsafe extern "system" fn __glCheckFramebufferStatus(_target: FramebufferTarget) {
            ...
            glIsVertexArray: unsafe {
                unsafe extern "system" fn __glIsVertexArray(_array: GLuint) {
...
impl EntryFnGL32 {
        ...
        F: FnMut(&::std::ffi::CStr) -> *const c_void,
    {
        Self {
            ...
            glIsSync: unsafe {
                unsafe extern "system" fn __glIsSync(_sync: GLsync) {
...
impl EntryFnGL11 {
        ...
        F: FnMut(&::std::ffi::CStr) -> *const c_void,
    {
        Self {
            ...
            glIsTexture: unsafe {
                unsafe extern "system" fn __glIsTexture(_texture: GLuint) {
...
impl EntryFnGL33 {
        ...
        F: FnMut(&::std::ffi::CStr) -> *const c_void,
    {
        Self {
            ...
            glIsSampler: unsafe {
                unsafe extern "system" fn __glIsSampler(_sampler: GLuint) {
            ...
            glGetFragDataIndex: unsafe {
                unsafe extern "system" fn __glGetFragDataIndex(_program: GLuint, _name: GLchar) {
        ...
        F: FnMut(&::std::ffi::CStr) -> *const c_void,
    {
        Self {
            ...
            glIsProgramPipeline: unsafe {
                unsafe extern "system" fn __glIsProgramPipeline(_pipeline: GLuint) {
