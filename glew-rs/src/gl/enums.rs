...
#[repr(transparent)]
#[derive(Clone, Copy, PartialEq, Eq, PartialOrd, Ord, Hash)]
pub struct TransformFeedbackTokenNV(pub(crate) u64);
impl TransformFeedbackTokenNV {
    pub const GL_SKIP_COMPONENTS1_NV: Self = Self(-6);
    pub const GL_SKIP_COMPONENTS3_NV: Self = Self(-4);
    pub const GL_NEXT_BUFFER_NV: Self = Self(-2);
    pub const GL_SKIP_COMPONENTS4_NV: Self = Self(-3);
    pub const GL_SKIP_COMPONENTS2_NV: Self = Self(-5);
}
#[repr(transparent)]
#[derive(Clone, Copy, PartialEq, Eq, PartialOrd, Ord, Hash)]
