...
#[allow(non_camel_case_types)]
pub type PFN_glXGetProcAddress = unsafe extern "system" fn(_procName: GLubyte);
#[allow(non_camel_case_types)]
pub type PFN_glXQueryFrameCountNV =
    unsafe extern "system" fn(_dpy: Display, _screen: GLvoid, _count: GLuint);
#[allow(non_camel_case_types)]
pub type PFN_glXGetCurrentDrawable = unsafe extern "system" fn();
#[allow(non_camel_case_types)]
...
pub type PFN_glXCreateGLXPixmap =
    unsafe extern "system" fn(_dpy: Display, _visual: XVisualInfo, _pixmap: Pixmap);
#[allow(non_camel_case_types)]
...
pub type PFN_glXQueryHyperpipeNetworkSGIX =
    unsafe extern "system" fn(_dpy: Display, _npipes: GLvoid);
#[allow(non_camel_case_types)]
...
pub type PFN_glXCreateAssociatedContextAMD =
    unsafe extern "system" fn(_id: GLvoid, _share_list: GLXContext);
#[allow(non_camel_case_types)]
...
pub type PFN_glXGetFBConfigFromVisualSGIX =
    unsafe extern "system" fn(_dpy: Display, _vis: XVisualInfo);
#[allow(non_camel_case_types)]
...
#[allow(non_camel_case_types)]
pub type PFN_glXCreateGLXPixmapWithConfigSGIX =
    unsafe extern "system" fn(_dpy: Display, _config: GLXFBConfigSGIX, _pixmap: Pixmap);
#[allow(non_camel_case_types)]
...
pub type PFN_glXImportContextEXT =
    unsafe extern "system" fn(_dpy: Display, _contextID: GLXContextID);
#[allow(non_camel_case_types)]
pub type PFN_glXSwapIntervalSGI = unsafe extern "system" fn(_interval: GLvoid);
#[allow(non_camel_case_types)]
pub type PFN_glXIsDirect = unsafe extern "system" fn(_dpy: Display, _ctx: GLXContext);
#[allow(non_camel_case_types)]
...
#[allow(non_camel_case_types)]
pub type PFN_glXGetProcAddressARB = unsafe extern "system" fn(_procName: GLubyte);
#[allow(non_camel_case_types)]
pub type PFN_glXResetFrameCountNV = unsafe extern "system" fn(_dpy: Display, _screen: GLvoid);
#[allow(non_camel_case_types)]
...
pub type PFN_glXBindSwapBarrierNV =
    unsafe extern "system" fn(_dpy: Display, _group: GLuint, _barrier: GLuint);
#[allow(non_camel_case_types)]
pub type PFN_glXQueryVersion = unsafe extern "system" fn(_dpy: Display, _maj: GLvoid, _min: GLvoid);
#[allow(non_camel_case_types)]
pub type PFN_glXMakeAssociatedContextCurrentAMD = unsafe extern "system" fn(_ctx: GLXContext);
#[allow(non_camel_case_types)]
...
#[allow(non_camel_case_types)]
pub type PFN_glXGetCurrentContext = unsafe extern "system" fn();
#[allow(non_camel_case_types)]
...
#[allow(non_camel_case_types)]
pub type PFN_glXDeleteAssociatedContextAMD = unsafe extern "system" fn(_ctx: GLXContext);
#[allow(non_camel_case_types)]
pub type PFN_glXGetCurrentAssociatedContextAMD = unsafe extern "system" fn();
#[allow(non_camel_case_types)]
...
#[allow(non_camel_case_types)]
pub type PFN_glXGetCurrentReadDrawable = unsafe extern "system" fn();
#[allow(non_camel_case_types)]
...
pub type PFN_glXDelayBeforeSwapNV =
    unsafe extern "system" fn(_dpy: Display, _drawable: GLXDrawable, _seconds: GLfloat);
#[allow(non_camel_case_types)]
pub type PFN_glXGetContextGPUIDAMD = unsafe extern "system" fn(_ctx: GLXContext);
#[allow(non_camel_case_types)]
pub type PFN_glXGetCurrentDisplayEXT = unsafe extern "system" fn();
#[allow(non_camel_case_types)]
...
pub type PFN_glXMakeCurrent =
    unsafe extern "system" fn(_dpy: Display, _drawable: GLXDrawable, _ctx: GLXContext);
#[allow(non_camel_case_types)]
...
pub type PFN_glXGetVisualFromFBConfig =
    unsafe extern "system" fn(_dpy: Display, _config: GLXFBConfig);
#[allow(non_camel_case_types)]
...
pub type PFN_glXQueryExtension =
    unsafe extern "system" fn(_dpy: Display, _errorb: GLvoid, _event: GLvoid);
#[allow(non_camel_case_types)]
...
#[allow(non_camel_case_types)]
pub type PFN_glXGetCurrentReadDrawableSGI = unsafe extern "system" fn();
#[allow(non_camel_case_types)]
...
pub type PFN_glXQueryMaxSwapBarriersSGIX =
    unsafe extern "system" fn(_dpy: Display, _screen: GLvoid, _max: GLvoid);
#[allow(non_camel_case_types)]
...
pub type PFN_glXQueryCurrentRendererIntegerMESA =
    unsafe extern "system" fn(_attribute: GLvoid, _value: GLvoid);
#[allow(non_camel_case_types)]
pub type PFN_glXGetContextIDEXT = unsafe extern "system" fn(_context: GLXContext);
#[allow(non_camel_case_types)]
pub type PFN_glXCreateAssociatedContextAttribsAMD =
    unsafe extern "system" fn(_id: GLvoid, _share_context: GLXContext, _attribList: GLvoid);
#[allow(non_camel_case_types)]
...
#[allow(non_camel_case_types)]
pub type PFN_glXCreatePbuffer =
    unsafe extern "system" fn(_dpy: Display, _config: GLXFBConfig, _attrib_list: GLvoid);
#[allow(non_camel_case_types)]
...
#[allow(non_camel_case_types)]
pub type PFN_glXSet3DfxModeMESA = unsafe extern "system" fn(_mode: GLint);
#[allow(non_camel_case_types)]
pub type PFN_glXGetCurrentDisplay = unsafe extern "system" fn();
#[allow(non_camel_case_types)]
...
pub type PFN_glXJoinSwapGroupNV =
    unsafe extern "system" fn(_dpy: Display, _drawable: GLXDrawable, _group: GLuint);
#[allow(non_camel_case_types)]
...
pub type PFN_glXReleaseBuffersMESA =
    unsafe extern "system" fn(_dpy: Display, _drawable: GLXDrawable);
#[allow(non_camel_case_types)]
...
#[allow(non_camel_case_types)]
pub type PFN_glXQueryHyperpipeConfigSGIX =
    unsafe extern "system" fn(_dpy: Display, _hpId: GLvoid, _npipes: GLvoid);
#[allow(non_camel_case_types)]
...
pub type PFN_glXGetVisualFromFBConfigSGIX =
    unsafe extern "system" fn(_dpy: Display, _config: GLXFBConfigSGIX);
#[allow(non_camel_case_types)]
pub type PFN_glXChooseVisual =
    unsafe extern "system" fn(_dpy: Display, _screen: GLvoid, _attribList: GLvoid);
#[allow(non_camel_case_types)]
