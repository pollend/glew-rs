...
pub trait GL45 {
    ...
    unsafe fn glGetnPixelMapusv(&self, _map: PixelMap, _bufSize: GLsizei, _values: *mut GLushort) {
    ...
    unsafe fn glCreateTextures(&self, _target: TextureTarget, _n: GLsizei, _textures: *mut GLuint) {
    ...
    unsafe fn glMemoryBarrierByRegion(&self, _barriers: MemoryBarrierMask) {
    ...
    unsafe fn glGetnPixelMapfv(&self, _map: PixelMap, _bufSize: GLsizei, _values: *mut GLfloat) {
    ...
    unsafe fn glClipControl(&self, _origin: ClipControlOrigin, _depth: ClipControlDepth) {
    ...
    unsafe fn glGetnPixelMapuiv(&self, _map: PixelMap, _bufSize: GLsizei, _values: *mut GLuint) {
    ...
    unsafe fn glNamedFramebufferDrawBuffer(&self, _framebuffer: GLuint, _buf: ColorBuffer) {
    ...
    unsafe fn glNamedFramebufferReadBuffer(&self, _framebuffer: GLuint, _src: ColorBuffer) {
    ...
    unsafe fn glCreateQueries(&self, _target: QueryTarget, _n: GLsizei, _ids: *mut GLuint) {
